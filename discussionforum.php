...
<body>
    ...
    <div class="whole-document-area">
        <div class="discussion">
                        ...
                        <?php
                            ...
                            if ($_SERVER["REQUEST_METHOD"] == "POST") {
                                ...
                                if(isset($_POST['submit'])) {
                                    ...
                                    $sql = "INSERT INTO posts (specified_concern, content) VALUES (?, ?)";
            ...
            <!-- POST AREA -->
            <?php
                $sql = "SELECT username, content, specified_concern FROM posts";
                ...
                if ($result->num_rows > 0) {
                    while ($row = $result->fetch_assoc()) {
                        ...
                        echo '<div class="comment-outline" onclick="toggleComments()">';
                    ...
                    <div class="comment-section">
                        ...
                        <div class="comments-content">
                            ...
                            <div class="comment">
                                <div class="user-info">
                                    <div class="user-icon">
                                        <img src="C:\xampp\htdocs\New DavHow\valid_id\icons\user-icon.svg" alt="">               
                                    </div>
                                    <p class="username"></p>
                                </div>
                                <div class="content">
