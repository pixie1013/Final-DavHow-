...
<head>
    ...
    <title>DavHow: Community Tax Certificate (CEDULA)</title>
    ...
    <header class="header" id="header">
      ...
      <div class="whole-document-area">
        ...
        <section class="document-area">
            <div class="image-wrapper">
                ...
                <div class="document-text">
                    ...
                    <p>A Community Tax Certificate (CTC), commonly known as a "cedula" in the Philippines, is a document that certifies an individual has paid the community tax, as mandated by the Local Government Code.</p>
                    <p>This is eligible to any individual or citizen at least 18 years of age and above or juridical being for identifying himself and his residence which can be used for legal transaction.</p>
                    <p><strong>Note:</strong></p>
                    <p>Different barangays or municipalities may have distinct procedures and requirements for obtaining a Community Tax Certificate (CEDULA). While the information offered describes general steps, it is recommended to directly contact the barangay or municipal office for a thorough understanding of the specific requirements involved in acquiring a Community Tax Certificate.</p>
                </div>
            </div>
        </section>    
        ...
        <div class="requirement-info">
            ...
            <div class="info-box">
                <h3 class="requirement">Accomplished Community Tax Declaration Form</h3>
                <p>1 copy</p>
           </div>
            <div class="info-box">
                <h3 class="requirement">1 Valid ID</h3>
                <p>Any government-issued identification ensuring accurate identification and documentation of an individuals.</p>
            </div>
            <div class="info-box">
            ...
            <div class="info-box">
                <h3 class="requirement">Pay Slip</h3>
                <p></p>
            </div>
        </div> 
        ...
        <div class="requirement-info">
            ...
            <div class="info-box">
                <h3 class="requirement">Approved business tax declaration as evaluated by the City Treasurer’s office</h3>
                <p></p>
            </div>
        </div> 
         ...
         <div class="procedure-info">
            <div class="info-box">
                ...
                <div class="info-details">
                    <h3 class="requirement">Visit the Barangay, Municipal, or City Hall</h3>
                    <p>Go to the designated counter or window for cedula applications.</p>                    
                </div>
            </div>
            <div class="info-box">
                <div class="circle-background">
                ...
                <div class="info-details">
                    <h3 class="requirement">Complete the Community Tax Declaration Form</h3>
                    <p>Provide the required information on the form.</p>
                </div>
            </div>
            <div class="info-box">
                <div class="circle-background">
                    ...
                    <div class="info-details">
                        <h3 class="requirement">Submit the Form and Required Documents</h3>
                        <p>Submit the completed form for encoding.</p>
                        <p>Present your valid ID and any required documents.</p>
                        <p>Employed individuals should present proof of income.</p>
                        <p>Business owners can present business assessments.</p>
                    </div>
            </div>
            <div class="info-box">
                <div class="circle-background">
                    ...
                    <div class="info-details">
                        <h3 class="requirement">Pay the Fees</h3>
                        <p>Settle the necessary fees at the payment counter.</p>
                        <p>Sign the copies and affix your thumbprint as required by the issuing officer.</p>
                    </div>
            </div>
            <div class="info-box">
                <div class="circle-background">
                    ...
                    <div class="info-details">
                        <h3 class="requirement">Wait for Issuance</h3>
                        <p>Await the issuance of your copy of the cedula.</p>
                    </div>
                </div>
            </div>          
            ...
            <div class="location-info" hidden>
                <iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3959.5292139998946!2d125.60507907304853!3d7.064467516644606!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x32f96d78c24bbd93%3A0x59ce07b02e60810c!2sCity%20Treasurer&#39;s%20Office!5e0!3m2!1sen!2sph!4v1716316797314!5m2!1sen!2sph" width="600" height="450" style="border:0;" allowfullscreen="" loading="lazy" referrerpolicy="no-referrer-when-downgrade"></iframe>
                <div class="details-container">
                <!-- LIST OF LOCATIONS -->
                    <div class="location-details">
                        <strong><p><a target=”_blank” href="https://maps.app.goo.gl/JrVns7n9T7ms59n48">City Treasurer’s Office</a></p></strong>                                                         
                        <table>
                            <tr>
                                <td>Address</td>
                                <td>Room 1, City Hall Bldg., San Pedro St., Davao City</td>
                            </tr>
                            <tr>
                                <td>Email</td>
                                <td>cto@davaocity.gov.ph</td>
                            </tr>
                            <tr>
                                <td>Phone</td>
                                <td>(082) 241-1000 local 232 /  225-02-00</td>
                            </tr>
                        </table>                    
                 </div>
                </div>
            ...
            <div class="fee-info" hidden>
                <div class="no-fee">
                    <p>Cedula fees vary based on your municipality, profession, income level, and business activities.</p> 
                </div>
                <div class="fee">
                    <h3 class="fee-type">For Individuals</h3>
                </div>
                <div class="fee">
                    <table>
                            <tr>
                                <strong><td class="fee-name">Basic Communtiy tax</td></strong>
                                <td rowspan="2">PHP 5.00<span>(minimum)</span></td>
                            </tr>
                            <tr>
                ...
                <div class="fee">
                    <table>
                            <tr>
                                <strong><td class="fee-name">Additional tax on prior year's earnings</td></strong>
                                <td rowspan="2">Php 1 per Php 1,000 </td>
                            </tr>
                            <tr>
                                <td class="fee-location">Should not exceed ₱5,000. </td>                    
                            </tr>
                    </table>
                </div>
                <div class="fee">
                    <table>
                            <tr>
                                <strong><td class="fee-name">Property’s total assessed value</td></strong>
                                <td rowspan="2">Php 1 per Php 1,000 </td>
                            </tr>
                            <tr>
                                <td class="fee-location"></td>                    
                ...
                <div class="fee">
                    <h3 class="fee-type">For Corporations</h3>
                </div>
                <div class="fee">
                    <table>
                            <tr>
                ...
                <div class="fee">
                    <table>
                            <tr>
                                <strong><td class="fee-name">Additional tax on prior year's earnings</td></strong>
                                <td rowspan="2">Php 2 per Php 5,000 </td>
                            </tr>
                            <tr>
                                <td class="fee-location">Should not exceed ₱10,000. </td>                    
                            </tr>
                    </table>
                </div>
                <div class="fee">
            ...
            <div class="samplephoto-info" >
                ...
                <div class="img-magnifier-container" onmouseover="magnify(reference-photo, 3)">
                    <img id="reference-photo" src="/New DavHow/documents/document_images/Cedula.jpg" alt="">
                </div>
            </div>
            ...
            <div class="reference-info">
                <div class="article-reference">
                    <a href="https://sanclementetarlac.gov.ph/government/municipal-treasury-office/community-tax-certificate-ctc-or-cedula/#:~:text=A%20Community%20Tax%20Certificate%20(CTC,person%20may%20secure%20a%20CTC." target="_blank">Community Tax Certificate (CTC) or “Cedula”</a>
                </div>
                <div class="article-reference">
                    <a href="https://www.moneymax.ph/government-services/articles/how-to-get-cedula" target="_blank">Sample CEDULA</a>
                </div>
            </div>
        </section>
      </div>
