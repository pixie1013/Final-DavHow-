...
<head>
    ...
    <title>DavHow: Certificate of Live Birth - Out of Town Registration</title>
...
<header class="header1">
    ...
    <section class="document-area">
        <div class="image-wrapper">
            ...
            <div class="document-text">
                <h1>CERTIFICATE OF LIVE BIRTH - Out of Town Registration</h1>
                ...
                <p>This is eligible to all persons residing in Davao but born outside Davao City.</p>
            </div>
        </div>
    </section>    
    ...
    <section class="information-area">
        ...
        <div class="requirement-info">
            ...
            <div class="info-box">
                <h3 class="requirement">Affidavit of Registration to be corroborated by 2 witnesses</h3>
                <p>1 original, 3 photocopies</p>
           </div>
            <div class="info-box">
                <h3 class="requirement">Negative result from (PSA) Philippine Statistics Authority</h3>
                <p>1 original, 3 photocopies</p>
            </div>
            <div class="info-box">
                <h3 class="requirement">Baptismal certificate (certified)</h3>
                <p>1 original, 3 photocopies</p>
            </div>
            <div class="info-box">
                <h3 class="requirement">School records (form 137-E or transcript)</h3>
                <p>1 original, 3 photocopies</p>
            </div>
            <div class="info-box">
                <h3 class="requirement">Voter’s Affidavit for 18 years old and above</h3>
                <p>1 original copy, 3 photocopies</p>
            </div>
            <div class="info-box">
                <h3 class="requirement">Marriage Contract of Parents</h3>
                <p>1 original, 3 photocopies</p>
            </div>
            <div class="info-box">
                <h3 class="requirement">Marriage Contract of applicant (if female & married)</h3>
                <p>1 original copy, 3 photocopies</p>
            </div>
            <div class="info-box">
                <h3 class="requirement">Community Tax Certificate (new)</h3>
                <p>1 original, 3 photocopies</p>
            </div>
            <div class="info-box">
                <h3 class="requirement">E1 form (SSS) Social Security System (microfilmed)</h3>
                <p>1 original, 3 photocopies</p>
            </div>
            <div class="info-box">
                <h3 class="requirement">NBI (National Bureau of Investigation) clearance (old) / passport</h3>
                <p>1 original, 3 photocopies</p>
            </div>
            <div class="info-box">
                <h3 class="requirement">Service record (if employed)</h3>
                <p>1 original, 3 photocopies</p>
            </div>
            <div class="info-box">
                <h3 class="requirement">Valid ID card</h3>
                <p>1 original, 3 photocopies</p>
            </div>
            <div class="info-box">
                <h3 class="requirement">Postal Money Order/Peso Pack payable to the Municipality/City Civil</h3>
                <p>1 original, 3 photocopies</p>
            </div>
        </div> 
        ...
        <div class="procedure-info">
            <div class="info-box">
                ...
                <div class="info-details">
                    <h3 class="requirement">Requirement Submission</h3>
                    <p>Submit required supporting documents in Window 19.</p>
                </div>
            </div>
            <div class="info-box">
                <div class="circle-background">
                ...
                <div class="info-details">
                    <h3 class="requirement">Draft and Sign</h3>
                    <p>Fill-up draft and sign Certificate of Live Birth (COLB).</p>
                </div>
            </div>
            <div class="info-box">
                <div class="circle-background">
                ...
                <div class="info-details">
                    <h3 class="requirement">Fees Payment</h3>
                    <p>Pay at the cashier in Window 15.</p>
                </div>
            </div>
            <div class="info-box">
                <div class="circle-background">
                ...
                <div class="info-details">
                    <h3 class="requirement">Obtain Stub</h3>
                    <p>Get the claim stub in Window 19.</p>
                </div>
            </div>
            <div class="info-box">
                <div class="circle-background">
                ...
                <div class="info-details">
                    <h3 class="requirement">Mail Prepared COLB at LBC Courier/Peso Pack</h3>
                    <p>Come back after 5 working days (Window 19), get the prepared COLB (Certificate of Live Birth) for mailing at LBC Courier/Peso Pack and give back a photocopy of the receipt/proof of mailing.</p>
                </div>
            </div>
            <div class="info-box">
                <div class="circle-background">
                ...
                <div class="info-details">
                    <h3 class="requirement">Mailing</h3>
                    <p>Receive a complete set of documents for mailing.</p>
                </div>
            </div>
            <div class="info-box">
                <div class="circle-background">
                ...
                <div class="info-details">
                    <h3 class="requirement">Submit Photocopy and Claim Stub</h3>
                    <p>Submit the photocopy of the courier receipt and the claim stub.</p>
                </div>
            </div>
        </div>
        ...
        <div class="fee-info" hidden>
            <div class="fee">
                <table>
                        <tr>
                            <strong><td class="fee-name">Order of Payment to Client for Service</td></strong>
            ...
            <div class="total-fee fee">
                <table>
                        <tr>
                            ...
                            <td rowspan="2"><strong>PHP 100.00</strong></td>
                        </tr>
                </table>
            </div>
        </div>  
