...
<head>
    ...
    <title>DavHow: Manual Tax Declaration</title>
...
<header class="header1">
    ...
    <section class="document-area">
        <div class="image-wrapper">
            ...
            <div class="document-text">
                <h1>CERTIFIED TRUE COPY OF TAX DECLARATION - MANUAL TAX DECLARATION</h1>
                <p>Declaration of real property value for real property taxation purposes.</p><br>
            </div>
        </div>
    </section>    
    ...
    <section class="information-area">
        ...
        <div class="requirement-info">
            <div class="info-box">
                <h3 class="requirement">Filled-up Request Form</h3>
                <p>Submit a completed request form.</p>
            </div>
            
            <div class="info-box">
                <h3 class="requirement">PIN Verification</h3>
                <p>If no PIN is available, proceed to Windows 1-4 for PIN verification.</p>
            </div>
            
            <div class="info-box">
                <h3 class="requirement">Valid ID</h3>
                <p>Provide a valid ID of the property owner and the requestor or authorized representative.</p>
            </div>
            
            <div class="info-box">
                <h3 class="requirement">Authorization Letter</h3>
                <p>Include an authorization letter from the owner with photocopy of signatories and authorized representatives; 1 original.</p>
            </div>
            
            <div class="info-box">
                <h3 class="requirement">Secretary's Certificate</h3>
                <p>If corporation, provide a Secretary’s Certificate with photocopy of signatories and authorized representatives; 1 photocopy.</p>
            </div>                   
        </div>        
         ...
         <div class="procedure-info">
            <div class="info-box">
                ...
                <div class="info-details">
                    <h3 class="requirement">Proceed to the Queuing Counter to secure Priority Number and Order of payment</h3>
                    <p>Approach the Queuing Counter to obtain a priority number and determine the order of payment.</p>
                </div>
            </div>
            ...
            <div class="info-box">
                ...
                <div class="info-details">
                    <h3 class="requirement">Proceed to City Treasurer’s Office to pay Service Fees for Tax Declaration</h3>
                    <p>Head to the City Treasurer’s Office to settle the required service fees for the tax declaration.</p>
                </div>
            </div>
            ...
            <div class="info-box">
                ...
                <div class="info-details">
                    <h3 class="requirement">Proceed to Window 12 for submission of Request Form and requirements</h3>
                    <p>Wait for your number to be called and then proceed to Window 12 to submit the Request Form and necessary requirements.</p>
                </div>
            </div>
            ...
            <div class="info-box">
                ...
                <div class="info-details">
                    <h3 class="requirement">Proceed to the Queuing Counter to secure Priority Number then proceed to Window 13</h3>
                    <p>Obtain another priority number from the Queuing Counter and proceed to Window 13, then wait for your number to be called.</p>
                </div>
            </div>
            ...
            <div class="info-box">
                ...
                <div class="info-details">
                    <h3 class="requirement">Window 11 - Special Lane for Senior Citizens, PWD, and pregnant women</h3>
                    <p>If eligible, utilize the Special Lane dedicated to Senior Citizens, Persons with Disabilities (PWD), and pregnant women.</p>
                </div>
            </div>
            ...
            <div class="info-box">
                ...
                <div class="info-details">
                    <h3 class="requirement">Receive the document</h3>
                    <p>Once your transaction is processed, receive the document from the designated window.</p>
                </div>
            </div>                  
        </div>
            ...
            <div class="location-info" hidden>
                ...
                <!-- LIST OF LOCATIONS -->
                     <div class="location-details">
                        <strong><p><a target=”_blank” href="https://maps.app.goo.gl/rzkSmD93tfY7XmBn8">City Assessor's Office - Assessment Records Management Division</a></p></strong>                                                         
                        <table>
                            <tr>
                                <td>Address</td>
                                <td>Ground Floor., SP Building, San Pedro St., Davao City</td>
                            </tr>
                            <tr>
                                <td>Email</td>
                                <td>casso@davaocity.gov.ph</td>
                            </tr>
                            <tr>
                                <td>Phone</td>
                                <td>(082) 241-1000 local 372</td>
                            </tr>
                        </table>                    
                 </div>
                </div>
        ...
        <div class="fee-info" hidden>
            <div class="fee">
                <table>
                        <tr>
                            <strong><td class="fee-name">Certification Fee (per copy)</td></strong>
        ...
        <div class="samplephoto-info" >
            ...
            <div class="img-magnifier-container" onmouseover="magnify('reference-photo', 3)">
                <img id="reference-photo" src="/New DavHow/documents/document_images/Manual Tax Declaration.jpg" alt="">
            </div>  
        </div>
        ...
        <div class="reference-info">
            ...
            <div class="article-reference">
                <a href="httpsgomezrealty.blogspot.com201304documentary-requirements-in-securing.html" target="_blank">Sample Manual Tax Declaration</a>
            </div>
        </div>
    </section>
</div>
