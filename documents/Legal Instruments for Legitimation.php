...
<head>
    ...
    <title>DavHow: Legal Instrument for Legitimation</title>
...
<header class="header1">
    ...
    <section class="document-area">
        <div class="image-wrapper">
            ...
            <div class="document-text">
                <h1>LEGAL INSTRUMENTS FOR LEGITIMATION</h1>
                <p>A legal document that allows a child, whose parents were not married at the time of birth, but has a subsequent marriage, to use the surname of the father.</p>
                <p>This is eligible to all registered illegitimate person born in Davao City whose parents eventually married each other.</p>
            </div>
        </div>
    </section>    
    ...
    <section class="information-area">
        ...
        <div class="requirement-info">
            ...
            <div class="info-box">
                <h3 class="requirement">Marriage certificate of parents</h3>
                <p>1 certified true copy if place of marriage is in Davao City, if marriage is outside Davao City PSA copy must be presented</p>
            </div>
            <div class="info-box">
                <h3 class="requirement">Certificate of no marriage (CENOMAR) /Advisory of marriage of both parents</h3>
                <p>1 original and 2 photocopies</p>
            </div>
            <div class="info-box">
            ...
            <div class="info-box">
                <h3 class="requirement">Certificate of legal capacity (if father is foreigner)</h3>
                <p>1 original and 2 photocopies</p>
            </div>
        </div>
        ...
        <div class="procedure-info">
            <div class="info-box">
                ...
                <div class="info-details">
                    <h3 class="requirement">Prepare Civil Registry Records and Supporting Documents:</h3>
                    <p>Gather all necessary Civil Registry records and supporting documents required for the application.</p>
                </div>
            </div>
            ...
            <div class="info-box">
                ...
                <div class="info-details">
                    ...
                    <p>Complete the application form provided by the appropriate authority. Ensure all required information is accurately filled in.</p>
                </div>
            </div>
            ...
            <div class="info-box">
                ...
                <div class="info-details">
                    ...
                    <p>Sign the prepared affidavit related to the application.</p>
                    <p>Take the affidavit to a lawyer to have it notarized.</p>
                    <p>Pay any required fees at the City Treasurer’s Office related to the notarization process.</p>
                </div>
            </div>
            ...
            <div class="info-box">
                ...
                <div class="info-details">
                    <h3 class="requirement">Submit Application Forms and Official Receipt:</h3>
                    <p>Submit the filled-up application forms along with the Official Receipt (O.R.) to the administrative division responsible for recording.</p>
                    <p>Ensure all required documents are complete and in order before submission.</p>
                </div>
            </div>
            ...
            <div class="info-box">
                ...
                <div class="info-details">
                    <h3 class="requirement">Receive Registered Legal Instrument:</h3>
                    <p>After submission, wait for the administrative division to process the application.</p>
                    <p>Once processed, receive the registered legal instrument and Form 1-A with annotation.</p>
                </div>
            </div>                
        </div>
        ...
        <div class="samplephoto-info" >
            ...
            <div class="img-magnifier-container" onmouseover="magnify(reference-photo, 3)">
                <img id="reference-photo" src="/New DavHow/documents/document_images/Legal Instruments for Legitimation.jpg" alt="">
            </div>
        </div>
        ...
        <div class="reference-info">
            ...
            <div class="article-reference">
                <a href="httpsbinangonan.gov.phwp-contentuploads202107Joint-Affidavit-of-Legitimation-by-Subsequent-Marriage.pdf" target="_blank">Sample Legal Instrument for Legitimation</a>
            </div>
        </div>
    </section>
</div>
