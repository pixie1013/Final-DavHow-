...
<head>
    ...
    <title>DavHow: Barangay Certificate</title>
      ...
      <div class="whole-document-area">
        ...
        <section class="document-area">
            <div class="image-wrapper">
                ...
                <div class="document-text">
                    ...
                    <p>A Barangay Certificate is an official document issued by the barangay that certifies certain information about an individual, typically a resident of that specific barangay. This document may serve various purposes, such as verifying residency, affirming good moral character, or providing clearance for specific transactions or activities. The certificate usually includes basic details such as the individual's name, address, and other pertinent information relevant to the purpose for which the certificate is requested.</p>
                    <p><strong>Note: </strong>Different barangays may have unique requirements and procedures. While the provided information reflects common practices, it is advisable to contact your local barangay office for any additional or specific details related to obtaining a Barangay Certificate in your area.</p>
                </div>
            </div>
        </section>    
        ...
        <section class="information-area">
            ...
            <div class="requirement-info">
                ...
                <div class="info-box">
                    <h3 class="requirement">Any document proving your residency</h3>
                    <p>1 copy</p>
                </div>
            </div> 
            ...
            <div class="procedure-info">
                <div class="info-box">
                    ...
                    <div class="info-details">
                        <h3 class="requirement">Visit the Barangay Hall</h3>
                        <p>Go to the local barangay office.</p>
                    </div>
                </div>
                ...
                <div class="info-box">
                    ...
                    <div class="info-details">
                        <h3 class="requirement">Express Intention</h3>
                        <p>Approach a staff member and express your intention to obtain a barangay certification.</p>
                    </div>
                </div>
                ...
                <div class="info-box">
                    ...
                    <div class="info-details">
                        <h3 class="requirement">State Purpose</h3>
                        <p>Expect to be asked about the purpose of needing the certification.</p>
                    </div>
                </div>
                ...
                <div class="info-box">
                    ...
                    <div class="info-details">
                        <h3 class="requirement">Wait for Processing</h3>
                        <p>Once your request is approved, patiently wait for the processing of your barangay certificate.</p>
                    </div>
                </div>
                ...
                <div class="info-box">
                    ...
                    <div class="info-details">
                        ...
                        <p>Finally, receive the issued Barangay Certificate.</p>
                    </div>
                </div>                
            </div>          
            ...
            <div class="fee-info" hidden>
                <div class="no-fee info-box">
                    <p>Processing of Barangay Certificate is commonly free of charge.</p> 
                </div>
            </div>
            ...
            <div class="samplephoto-info" >
                ...
                <div class="img-magnifier-container" onmouseover="magnify(reference-photo, 3)">
                    <img id="reference-photo" src="/New DavHow/documents/document_images/Barangay Certificate.jpg" alt="">
                </div>
            </div>
            ...
            <div class="reference-info">
                <div class="article-reference">
                    <a href="httpswww.scribd.comdocument470690996barangay-certification-docx" target="_blank">Sample Barangay Certificate</a>
                </div>
            </div>
        </section>
      </div>
