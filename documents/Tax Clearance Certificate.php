...
<head>
    ...
    <title>DavHow: Tax Clearance Certificate</title>
      ...
      <div class="whole-document-area">
        ...
        <section class="information-area">
            ...
            <div class="requirement-info">
                <div class="info-box">
                    <h3 class="requirement">Special Power of Attorney (SPA) - Individual Taxpayer-Applicants</h3>
                    <p>Submit one original copy of valid and properly accomplished Special Power of Attorney (SPA) signed by the applicant, applicable only to applications through an authorized representative.</p>
                </div>
                
                <div class="info-box">
                    <h3 class="requirement">Secretary’s Certificate or Board Resolution - Corporation</h3>
                    <p>For Corporation: Provide one original copy of Secretary’s Certificate or one original copy of Board Resolution, with attached one photocopy of the latest General Information Sheet (GIS) duly received by the Securities and Exchange Commission (SEC).</p>
                </div>
                
                <div class="info-box">
                    <h3 class="requirement">Latest General Information Sheet (GIS) - One Person Corporation (OPC)</h3>
                    <p>For One Person Corporation (OPC): Include one photocopy of the latest General Information Sheet (GIS) duly received by the Securities and Exchange Commission (SEC) and one original copy of valid and properly accomplished Special Power of Attorney (SPA) signed by the applicant, applicable only to applications through an authorized representative.</p>
                </div>
                
                <div class="info-box">
                    <h3 class="requirement">Partnership’s Certificate or Partnership’s Resolution - Partnership</h3>
                    <p>For Partnership: Provide one original copy of Partnership’s Certificate OR Partnership’s Resolution.</p>
                </div>
                <div class="info-box">
                    <h3 class="requirement">Photocopy of Valid Identification Cards</h3>
                    <p>Submit one photocopy of each valid identification card (any government-issued ID) with three specimen signatures of the applicant and the authorized representative.</p>
                </div>
                
                <div class="info-box">
                    <h3 class="requirement">Proof of Payment of Certification Fee</h3>
                    <p>Include one photocopy of proof of payment of Certification Fee and loose documentary stamp worth ₱30.00.</p>
                </div>
                
                <div class="info-box">
                    <h3 class="requirement">Delinquency Verification Report (DVR)</h3>
                    <p>Provide one original copy of Delinquency Verification Report (DVR) issued by concerned RDO.</p>
                </div>
                
                <div class="info-box">
                    <h3 class="requirement">Duly Accomplished and Notarized Application Form</h3>
                    <p>Include one original copy of duly accomplished and notarized application form with attached documentary stamp worth ₱30.00.</p>
                </div>
            ...
            <div class="procedure-info">
                <div class="info-box">
                    ...
                    <div class="info-details">
                        <h3 class="requirement">Taxpayer fills out the application form</h3>
                        <p>The taxpayer completes the application form required for obtaining the Tax Clearance Certificate.</p>
                    </div>
                </div>
                ...
                <div class="info-box">
                    ...
                    <div class="info-details">
                        <h3 class="requirement">File the application form with the Receiving Officer of RCD</h3>
                        <p>The taxpayer submits the filled-out application form to the Receiving Officer of the Revenue Collection Division (RCD).</p>
                    </div>
                </div>
                ...
                <div class="info-box">
                    ...
                    <div class="info-details">
                        <h3 class="requirement">Receive Tax Clearance Certificate for General Purpose</h3>
                        <p>After processing, the taxpayer receives the Tax Clearance Certificate for General Purpose from the designated authority.</p>
                    </div>
                </div>                                               
            </div>          
            ...
            <div class="samplephoto-info" >
                ...
                <div class="img-magnifier-container" onmouseover="magnify(reference-photo, 3)">
                    <img id="reference-photo" src="/New DavHow/documents/document_images/Tax Clearance Certificate.jpg" alt="">
                </div>
            </div>
            ...
            <div class="reference-info">
                <div class="article-reference">
                    <a href="httpsimgv2-1-f.scribdassets.comimgdocument483180308originaldc78da833a1698893194v=1">Sample Tax Clearance Certificate</a>
                </div>
            </div>
        </section>
      </div>
