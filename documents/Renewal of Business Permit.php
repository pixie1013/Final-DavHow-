...
<head>
    ...
    <title>DavHow: Renewal of Business Permit</title>
...
<body>
    ...
    <section class="document-area">
        <div class="image-wrapper">
            ...
            <div class="document-text">
                <h1>Renewal of Business Permit</h1>
    ...
    <section class="information-area">
        ...
        <div class="requirement-info">
            <div class="info-box">
                <h3 class="requirement">Previous Mayor’s Permit</h3>
                <p>Provide one copy of the Previous Mayor’s Permit.</p>
            </div>
            
            <div class="info-box">
                <h3 class="requirement">List of Employees</h3>
                <p>Include one copy of the List of Employees stating the Name and Position of the Employees.</p>
            </div>
            
            <div class="info-box">
                <h3 class="requirement">Valid IDs</h3>
                <p>Submit one photocopy of the valid ID of the Taxpayer for Sole Proprietorship, of Partners if Partnership, and of Authorized Signatory for other forms of ownership.</p>
            </div>
            
            <div class="info-box">
                <h3 class="requirement">Special Power of Attorney (Sole Proprietorship)</h3>
                <p>Include a Special Power of Attorney, if represented, indicating specific authority and capacity granted to the representative for Sole Proprietorship.</p>
            </div>
            
            <div class="info-box">
                <h3 class="requirement">Partners Resolution (Partnership)</h3>
                <p>Provide a Partners Resolution, if represented, indicating specific authority and capacity granted to the representative for Partnership.</p>
            </div>
            
            <div class="info-box">
                <h3 class="requirement">Board Resolution or Secretary’s Certificate</h3>
                <p>Include a Board Resolution or Secretary’s Certificate, if represented, indicating specific authority and capacity granted to the representative for other forms of ownership.</p>
            </div>
            
            <div class="info-box">
                <h3 class="requirement">Valid ID of Representative</h3>
                <p>Submit one photocopy of the valid ID of the representative.</p>
            </div>
            
            <div class="info-box">
                <h3 class="requirement">Valid Fire Safety Inspection Certificate</h3>
                <p>Provide one photocopy of the Valid Fire Safety Inspection Certificate.</p>
            </div>
            
            <div class="info-box">
                <h3 class="requirement">Specific Requirements</h3>
                <p>Submit any specific requirements for the specific line of business.</p>
            </div>            
        </div>
         ...
         <div class="procedure-info">
            <div class="subtype">
                ...
                <div class="info-box">
                    ...
                    <div class="info-details">
                        <h3 class="requirement">Submit Application and Requirements</h3>
                        <p>Present the completed application form along with all necessary documents to the Licensing Officer.</p>
                    </div>
                </div>
                ...
                <div class="info-box">
                    ...
                    <div class="info-details">
                        ...
                        <p>Upon assessment, the applicant may receive either a Disapproved Application notice or a System Approval Slip indicating further steps.</p>
                    </div>
                </div>
                ...
                <div class="info-box">
                    ...
                    <div class="info-details">
                        ...
                        <p>If the application is approved, an assessment of local taxes and charges is issued, along with an official receipt.</p>
                    </div>
                </div>
                ...
                <div class="info-box">
                    ...
                    <div class="info-details">
                        ...
                        <p>The applicant receives the assessment indicating the amount to be paid for taxes, fees, and charges.</p>
                    </div>
                </div>
                ...
                <div class="info-box">
                    ...
                    <div class="info-details">
                        <h3 class="requirement">Payment of Taxes, Fees, and Charges</h3>
                        <p>Pay the specified taxes, fees, and charges according to the assessment received.</p>
                    </div>
                </div>
                ...
                <div class="info-box">
                    ...
                    <div class="info-details">
                        ...
                        <p>Once payment is made, the applicant receives a Fire Safety Inspection Certificate (FSIC) if required.</p>
                    </div>
                </div>
                ...
                <div class="info-box">
                    ...
                    <div class="info-details">
                        <h3 class="requirement">Submit Recommended Approval of Application</h3>
                        <p>Submit any recommended approval of the application, along with official receipts and pertinent documents, as required by the Licensing Officer.</p>
                    </div>
                </div>
                ...
                <div class="info-box">
                    ...
                    <div class="info-details">
                        <h3 class="requirement">Receive Business Permit, Business Identification Plate, Sticker, FSIC, and Applicant’s Copy of Requirements</h3>
                        <p>After completing all necessary steps and requirements, the applicant receives:</p>
                        <ul>
                            <li>Business Permit</li>
                            <li>Business Identification Plate</li>
                            <li>Sticker</li>
                            <li>Fire Safety Inspection Certificate (FSIC)</li>
                            <li>Applicant’s copy of the requirements</li>
                        </ul>
                    </div>
                </div>
            ...
            <div class="subtype">
                ...
                <div class="info-box">
                    ...
                    <div class="info-details">
                        <h3 class="requirement">Client Login and Update Contact Information</h3>
                        <p>Log in to <a href="https://appbts.davaocity.gov.ph">appbts.davaocity.gov.ph</a> to update contact details such as email address and phone numbers. Upload required documents including IDs (owner and authorized representative if applicable), selfie holding an ID of owner and authorized representative, SPA for single proprietorship, and SEC. CERT. for Corporation.</p>
                        <p>Once submitted, the client will receive an access code via email and SMS.</p>
                    </div>
                </div>
                ...
                <div class="info-box">
                    ...
                    <div class="info-details">
                        <h3 class="requirement">Renew Business Permit</h3>
                        <p>Fill out the web forms for business permit renewal and submit along with required documents.</p>
                    </div>
                </div>
                ...
                <div class="info-box">
                    ...
                    <div class="info-details">
                        ...
                        <p>Check the status of the application. If approved by ROs (Revenue Officers), proceed to payment of fees. If pending, comply with additional requirements. If denied, proceed to ROs denying the application for further information.</p>
                    </div>
                </div>
                ...
                <div class="info-box">
                    ...
                    <div class="info-details">
                        <h3 class="requirement">Payment of Taxes, Charges, and Fees</h3>
                        <p>Make a one-time payment of taxes, charges, and fees either online or at the window.</p>
                    </div>
                </div>
                ...
                <div class="info-box">
                    ...
                    <div class="info-details">
                        <h3 class="requirement">Online Payment</h3>
                        <p>Pay online through the provided payment gateway.</p>
                    </div>
                </div>
                ...
                <div class="info-box">
                    ...
                    <div class="info-details">
                        <h3 class="requirement">Download and Print Business Permit</h3>
                        <p>After completing all necessary steps and payment, download and print the Business Permit.</p>
                        <p>Business plate and sticker may be delivered by a Business Bureau employee or claimed at the office.</p>
                    </div>
                </div>                             
            </div>         
        </div>
