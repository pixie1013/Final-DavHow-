...
<head>
    ...
    <title>DavHow: Certificate of Live Birth - Delayed Registration</title>
...
<header class="header1">
    ...
    <section class="document-area">
        <div class="image-wrapper">
            ...
            <div class="document-text">
                <h1>CERTIFICATE OF LIVE BIRTH - Delayed Registration</h1>
                ...
                <p>This is eligible to all persons born in Davao City after 1 month from the day the child was born.</p>
            </div>
        </div>
    </section>    
    ...
    <section class="information-area">
        ...
        <div class="requirement-info">
            <div class="requirement-info info-box requirement-description">
                <p>At least 3 or 4 of the following:</p>
            </div>
            <div class="info-box">
                <h3 class="requirement">Negative Result</h3>
                <p>For 2 years old and above</p>
           </div>
            <div class="info-box">
                <h3 class="requirement">Affidavit of two (2) disinterested person who might have witnessed or known the birth of the child</h3>
                <p>For 1 year old and above – 1 original</p>
            </div>
            <div class="info-box">
                <h3 class="requirement">Any 2 of the following documentary evidences which shows the name of the child, place of birth and the name of parents</h3>
                <p>▶ Baptismal/Dedication Certificate – 1 original, 1 photocopy</p>
                <p>▶ For 1 year old and above – 1 original</p>
                <p>▶ School Records (Form 137-E or Transcript) – 1 original, 1 photocopy</p>
                <p>▶ Voter’s Certificate – 1 original, 1 photocopy</p>
                <p>▶ Philhealth Members Data Record – 1 original</p>
                <p>▶ Passport/ Postal ID Card – 1 original, 1 photocopy</p>
                <p>▶ Service Record (If employed) – 1 original</p>
                <p>▶ Social Security System (SSS) Record (E/E-4/RS-1) – 1 original, 1 photocopy</p>
                <p>▶ Immunization Card – 1 original, 1 photocopy</p>
                <p>▶ Barangay Certificate (for 12 years old and below for home deliveries) – 1 original, 1 photocopy</p>
                <p>▶ Old cedula – 1 original, 1 photocopy</p>
            </div>
            <div class="info-box">
                <h3 class="requirement">Marriage Contract (Parents & Applicant if married)</h3>
                <p>1 original, 1 photocopy</p>
            </div>
            <div class="info-box">
                <h3 class="requirement">Birth certificate of siblings or birth certificate of son or daughter (eldest)</h3>
                <p>1 original, 1 photocopy</p>
            </div>
            <div class="info-box">
            ...
            <div class="info-box">
                <h3 class="requirement">Note:  In claiming a birth certificate, the client must present the following:</h3>
                <p>▶ Valid ID</p>
                <p>▶ If through a representative, authorization letter or Special Power of Attorney (SPA) with a valid ID of the authorizing person.</p>
            </div>
        </div> 
        ...
        <div class="procedure-info">
            <div class="info-box">
                ...
                <div class="info-details">
                    <h3 class="requirement">Fill Out Slip at the Front Desk</h3>
                    <p>Fill-out slip at the Front Desk and submit to Window 16 for verification of record.</p>                    
                </div>
            </div>
            <div class="info-box">
                <div class="circle-background">
                ...
                <div class="info-details">
                    <h3 class="requirement">Submit Request Slip and Supporting Documents</h3>
                    <p>Go to Window 19 and submit the request slip and required supporting documents.</p>
                </div>
            </div>          
            <div class="info-box">
                <div class="circle-background">
                ...
                <div class="info-details">
                    <h3 class="requirement">Typing of COLB Form</h3>
                    <p>Go to Window 19 and submit approved documents for typing of COLB (Certificate of Live Birth) Form</p>                    
                </div>
            </div>
            <div class="info-box">
                <div class="circle-background">
                ...
                <div class="info-details">
                    <h3 class="requirement">Register Affidavit to Use Surname of Father (If Applicable)</h3>
                    <p>For illegitimate child, it is advised to register Affidavit to Use Surname of Father at window 17 and to go back to window 19</p>
                </div>
            </div>
            <div class="info-box">
                <div class="circle-background">
                ...
                <div class="info-details">
                    <h3 class="requirement">Get Claim Stub</h3>
                    <p>Obtain the claim stub and come back after 10 day- posting</p>
                </div>
            </div>   
            <div class="info-box">
                <div class="circle-background">
                ...
                <div class="info-details">
                    <h3 class="requirement">Receive Registered Certificate of Live Birth</h3>
                    <p>Come back after the 10-day posting period to receive the registered copy of the Certificate of Live Birth (COLB)</p>
                </div>
            </div>
            <div class="info-box">
                <div class="circle-background">
        ...
        <div class="location-info" hidden>
            <iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3959.5322302331024!2d125.60625507397847!3d7.0641153166471105!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x32f96d78bad7d1a3%3A0x438c5f019b392085!2sCity%20Civil%20Registrar&#39;s%20Office!5e0!3m2!1sen!2sph!4v1716121610242!5m2!1sen!2sph" width="600" height="450" style="border:0;" allowfullscreen="" loading="lazy"></iframe>
        ...
        <div class="fee-info" hidden>
            <div class="no-fee">
                <p>Registration of the Delayed Certificate of Live Birth is free of charge.</p> 
            </div>
        </div>     
