...
<head>
    ...
    <title>DavHow: Affidavit to Use Surname of the Father</title>
    ...
    <div class="whole-document-area">
        ...
        <section class="document-area">
            <div class="image-wrapper">
                ...
                <div class="document-text">
                    <h1>AFFIDAVIT TO USE THE SURNAME OF THE FATHER (AUSF)</h1>
                    <p>An Affidavit to Use Surname of the Father is a legally binding document through which an illegitimate child attests, typically under oath, their desire to adopt the surname of their father. This affidavit serves as a formal declaration of the child's paternity and allows them to carry the paternal surname for various legal and personal purposes.</p>
                    <p>This is eligible to all registered illegitimate person born in Davao City.</p>
                </div>
            </div>
        </section>    
        ...
        <section class="information-area">
            ...
            <div class="requirement-info">
                <div class="info-box">
                    <h3 class="requirement">Certificate of Live Birth of the child</h3>
                    <p>1 PSA copy and 1 certified true copy</p>
                </div>
                <div class="info-box">
                    <h3 class="requirement">Valid identification cards of both parents</h3>
                    <p>1 photocopy</p>
                </div>
                <div class="info-box">
                    <h3 class="requirement">Personal appearance of both parents</h3>
                    <p></p>
                </div>
                <div class="info-box">
                    <h3 class="requirement">Personal appearance of the child (if needed)</h3>
                    <p></p>
                </div>            
            </div> 
            <!-- Procedure -->
            <div class="procedure-info">
                <div class="subtype">
                    <div class="category">
                        ...
                        <p class="subtype-text"><strong>For previously registered birth:</strong></p>
                    </div><hr>
                    <div class="info-box">
                        ...
                        <div class="info-details">
                            <h3 class="requirement">Submit Civil Registry Records and Supporting Documents</h3>
                            <p>Present/submit Civil Registry records together with supporting documents as required for evaluation.</p>
                        </div>
                    </div>
                    <div class="info-box">
                        <div class="circle-background">
                        ...
                        <div class="info-details">
                            <h3 class="requirement">Fill-up Application Form</h3>
                            <p>Complete the designated application form with accurate information as required.</p>
                        </div>
                    </div>
                    <div class="info-box">
                        <div class="circle-background">
                        ...
                        <div class="info-details">
                            <h3 class="requirement">Sign and Notarize Affidavit</h3>
                            <p>Sign the prepared affidavit and have it notarized to a lawyer and pay the required fees at City Treasurer’s Office</p>
                        </div>
                    </div>
                    <div class="info-box">
                        <div class="circle-background">
                        ...
                        <div class="info-details">
                            <h3 class="requirement">Submit Filled-up Application Forms with Official Receipt (O.R.)</h3>
                            <p>Present the filled-up application forms along with the Official Receipt (O.R.) from the City Treasurer’s Office to the administrative division for recording.</p>
                        </div>
                    </div>
                    <div class="info-box">
                        <div class="circle-background">
                        ...
                        <div class="info-details">
                            <h3 class="requirement">Receive Registered Legal Instrument and Form 1-A with Annotation</h3>
                            <p>After processing, receive the registered legal instrument along with Form 1-A containing necessary annotations.</p>
                        </div>
                    </div>
                </div>                   
                ...
                <div class="subtype">
                    <div class="category">
                        <img src="/New DavHow/valid_id/icons/black_backto-icon.svg" alt="">
                        <p class="subtype-text"><strong>For not yet registered birth:</strong></p>
                    </div><hr>
                    <div class="info-box">
                        <div class="circle-background">
                            <div class="procedure-number">
                        ...
                        <div class="info-details">
                            <h3 class="requirement">Form 102</h3>
                            <p>Present the prepared form 102 from clinics and hospital with AUSF</p>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="location-info" hidden>
                ...
                <div class="details-container">
                    ...
                    <div class="location-details">
                        <strong><p>Civil Registration Office-Legal Instrument and Court Degrees Division</p></strong>    
                        <table>
                            <tr>
                                <td>Address</td>
            ...
            <div class="fee-info" hidden>
                <div class="fee">
                    <table>
                            <tr>
                                <strong><td class="fee-name">Registration Fee if Father is Filipino</td></strong>
                ...
                <div class="fee">
                    <table>
                            <tr>
                                <strong><td class="fee-name">Registration Fee if Father is Foreign</td></strong>
                                <td rowspan="2">PHP 700.00</td>
                            </tr>
                            <tr>
                                <td class="fee-location">City Treasurer’s OFfice</td>                    
                            </tr>
                ...
                <div class="fee">
                    <table>
                            <tr>
                                <strong><td class="fee-name">Certification Fee (for previously registered birth)</td></strong>
                ...
                <div class="fee">
                    <table>
                            <tr>
                                <strong><td class="fee-name">Admission of paternity fee (if applicable) </td></strong>
                                <td rowspan="2">PHP 300.00</td>
                            </tr>
                            <tr>
                                <td class="fee-location">City Treasurer’s OFfice</td>                    
            ...
            <div class="samplephoto-info" >
                ...
                <div class="img-magnifier-container" onmouseover="magnify(reference-photo, 3)">
                    <img id="reference-photo" src="/New DavHow/documents/document_images/Affidavit to Use Surname of Father.jpg" alt="">
                </div>
                <div class="img-magnifier-container" onmouseover="magnify(reference-photo, 3)">
                    <img id="reference-photo" src="/New DavHow/documents/document_images/Affidavit to Use Surname of Father page 2.jpg" alt="">
                </div>
            </div>
            ...
            <div class="reference-info">
                ...
                <div class="article-reference">
                    <a href="httpsmilanpcg.dfa.gov.phimagesConsularFormsAffidavit_to_Use_Surname_of_Father_-_FILLABLE.pdf" target="_blank">Sample Affidavit to Use Surname of the Father</a>
                </div>
            </div>
        </section>
    </div>
