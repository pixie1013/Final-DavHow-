...
<head>
    ...
    <title>DavHow: PSA Marriage Certificate</title>
...
<header class="header1">
    ...
    <section class="document-area">
        <div class="image-wrapper">
            ...
            <div class="document-text">
                <h1>PSA Issued Marriage Certificate</h1>
                <p>The PSA Marriage Certificate is an official and legal document that provides information about a marriage. It includes details such as the names of the spouses, the date and place of the marriage, and the signatures of the witnesses. This certificate is considered a primary document for proving the validity of a marriage and is often required for various legal and official transactions, including changes in civil status, visa applications, and other government-related processes.</p>
            </div>
        </div>
    </section>    
    ...
    <section class="information-area">
        ...
        <div class="requirement-info">
            <div class="info-box">
                <h3 class="requirement">Printed or electronic copy of valid CRS Appointment Slip bearing the name of the client</h3>
                <p>1 copy</p>
            </div>
            <div class="info-box">
                <h3 class="requirement">Properly filled-out Health Survey Form or Updated QR Code of the COVID-19 Digital Contact Tracing App</h3>
                <p>1 copy</p>
            </div>
            <div class="info-box">
                <h3 class="requirement">Queue Ticket Number (QTN)</h3>
                <p>1 copy</p>
            </div>
            <div class="info-box">
                <h3 class="requirement">Completely filled-up Application Form (AF) - Marriage Certificate (Pink Form) accomplished in printed letters</h3>
                <p>1 copy</p>
            </div>
            <div class="info-box">
        ...
        <div class="requirement-info">
            <div class="eligibility-type info-box">
                ...
                <h2>Principal (Spouses/Husband and Wife)</h2>
            </div>
            <div class="info-box">
                <h3 class="requirement">Valid Identity Document (ID) of any of the contracting parties complete with clear photo, full name in print, signature and issued by an official authority</h3>
                <p>1 original</p>
            </div>
        </div>
        ...
        <div class="requirement-info">
            <div class="eligibility-type info-box">
                <img src="/New DavHow/valid_id/icons/backto-icon.svg" alt="">
                <h2>Direct Descendant (Marital Children and Non-Marital Children)</h2>
            </div>
            <div class="info-box">
                <h3 class="requirement">Valid Identity Document (ID) of the direct descendant of the contracting parties complete with clear photo, full name in print, signature and issued by an official authority</h3>
                <p>1 original</p>
            </div>
            <div class="info-box">
        ...
        <div class="requirement-info">
            <div class="eligibility-type info-box">
                <img src="/New DavHow/valid_id/icons/backto-icon.svg" alt="">
                <h2>Guardian to his/her ward</h2>
            </div>
            <div class="info-box">
                <h3 class="requirement">Court decision assigning the client as legal guardian</h3>
                <p>1 original and 1 photocopy</p>
            </div>
            <div class="info-box">
                <h3 class="requirement">Valid Identity Document (ID) of the Guardian complete with clear photo, full name in print, signature and issued by an official authority</h3>
                <p>1 original and 1 photocopy</p>
            </div>
        </div>
        ...
        <div class="requirement-info">
            <div class="eligibility-type info-box">
                <img src="/New DavHow/valid_id/icons/backto-icon.svg" alt="">
                <h2>Nearest of kin, if both contracting parties are deceased (Parents, Brother/Sister, Grandparent, Grandchildren)</h2>
            </div>
            <div class="info-box">
            ...
            <div class="info-box">
                <h3 class="requirement">Valid Identity Document (ID) of the nearest of kin requesting the document complete with clear photo, full name in print, signature and issued by an official authority</h3>
                <p>1 original and 1 photocopy</p>
            </div>
        </div>
        <div class="requirement-info">
            ...
            <div class="info-box">
                <h3 class="requirement">Valid Identity Document (ID) of any of the contracting parties (husband or wife) authorizing the representative complete with clear photo, full name in print, signature and issued by an official authority</h3>
                <p>1 original and 1 photocopy</p>
                <p>Reminder: For Authorization letter/Special Power of Attorney (SPA) received from abroad, document owner should provide a scanned/photocopy of the passport as valid ID.</p>
            </div>
            <div class="info-box">
                <h3 class="requirement">Valid Identity Document (ID) of the authorized representative complete with clear photo, full name in print, signature and issued by an official authority</h3>
                <p>1 original and 1 photocopy</p>
            </div>
            <div class="info-box">
                <h3 class="requirement">Authorization letter or duly notarized Special Power of Attorney</h3>
                <p>1 original</p>
            </div>
        </div>
        ...
        <div class="requirement-info">
            <div class="eligibility-type info-box">
                <img src="/New DavHow/valid_id/icons/backto-icon.svg" alt="">
                <h2>Senior Citizen requesting for his/her own marriage document and his/her parents</h2>
            </div>
            <div class="info-box">
                <h3 class="requirement">Senior Citizen’s ID Card or any valid ID indicating his/her age with clear photo, full name in print, signature and issued by an official authority</h3>
                <p>1 original</p>
            </div>
            <div class="info-box">
        ...
        <div class="requirement-info">
            <div class="eligibility-type info-box">
                <img src="/New DavHow/valid_id/icons/backto-icon.svg" alt="">
                <h2>Physically Challenged Client/PWD requesting for his/her marriage document and his/her parents</h2>
            </div>
            <div class="info-box">
                <h3 class="requirement">PWD ID Card with clear photo, full name in print, signature and issued by an official authority</h3>
                <p>1 original</p>
            </div>
            <div class="info-box">
                <h3 class="requirement">Philippine Identification (PhilID) Card</h3>
        ...
        <div class="requirement-info">
            <div class="eligibility-type info-box">
                <img src="/New DavHow/valid_id/icons/backto-icon.svg" alt="">
                <h2>Pregnant Woman requesting for her own marriage document and her parents</h2>
            </div>
            <div class="info-box">
        ...
        <div class="requirement-info">
            <div class="eligibility-type info-box">
                <img src="/New DavHow/valid_id/icons/backto-icon.svg" alt="">
                <h2>Health and Emergency Frontline Service Provider requesting for the copy issuance of his/her own marriage document and his/her parents</h2>
            </div>
            <div class="info-box">
        ...
        <div class="requirement-info">
            ...
            <div class="info-box">
                <h3 class="requirement">Philippine Identification (PhilID) Card or ePhilID</h3>
                <p>1 original</p>
                <p>Reminder: PhilID card/ePhilID holders are allowed to request only his/her own marriage document and his/her parents</p>
            </div>
        </div>
        ...
        <div class="requirement-info">
            <div class="eligibility-type info-box">
                <img src="/New DavHow/valid_id/icons/backto-icon.svg" alt="">
                <h2>First Time Jobseeker (RA 11261)</h2>
            </div>
            <div class="info-box">
            ...
            <div class="info-box">
                <h3 class="requirement">Oath of Undertaking executed by the First Time Jobseeker</h3>
                <p>1 original and 1 photocopy</p>
            </div>
            <div class="info-box">
                <h3 class="requirement">Valid Identity Document (ID) of the First Time Jobseeker complete with clear photo, full name in print, signature and issued by an official authority</h3>
                <p>1 original and 1 photocopy</p>
            </div>
        </div>
         ...
         <div class="procedure-info">
            <div class="subtype">
                ...
                <div class="info-box">
                    ...
                    <div class="info-details">
                        <h3 class="requirement">Initiate Order Process:</h3>
                ...
                <div class="info-box">
                    ...
                    <div class="info-details">
                        <h3 class="requirement">Select Marriage Certificate:</h3>
                        <p>On the next page, click the "Marriage" button.</p>
                        <p>Check the box at the bottom to accept the terms and conditions, then click "Continue."</p>
                    </div>
                </div>
                ...
                <div class="info-box">
                    ...
                    <div class="info-details">
                        ...
                        <p>Choose whether you're requesting your own PSA marriage certificate or for someone else.</p>
                ...
                <div class="info-box">
                    ...
                    <div class="info-details">
                        <h3 class="requirement">Provide Personal Information:</h3>
                        <p>Enter your personal details such as sex, civil status (if female), first name, middle name, last name, birth date, and the type of your government-issued ID.</p>
                ...
                <div class="info-box">
                    ...
                    <div class="info-details">
                        <h3 class="requirement">Enter Spouse's Details:</h3>
                        <p>Input your spouse’s details, including their first name, middle name, and last name.</p>
                        <p>Click “Continue” to proceed.</p>
                    </div>
                </div>
                ...
                <div class="info-box">
                    ...
                    <div class="info-details">
                        <h3 class="requirement">Specify Marriage Date:</h3>
                        <p>Input the date of your marriage.</p>
                        <p>Click “Continue” to proceed.</p>
                    </div>
                </div>
                ...
                <div class="info-box">
                    ...
                    <div class="info-details">
                        <h3 class="requirement">Indicate Place of Marriage:</h3>
                        <p>Select the country, province, and municipality where your marriage took place.</p>
                        <p>Click “Continue” to proceed.</p>
                    </div>
                </div>
                ...
                <div class="info-box">
                    ...
                    <div class="info-details">
                        ...
                        <p>Specify your purpose for requesting a copy of your marriage certificate.</p>
                        <p>Click “Continue” to proceed.</p>
                    </div>
                </div>
            ...
            <div class="subtype">
                ...
                <div class="info-box">
                    ...
                    <div class="info-details">
                        ...
                        <p>Visit <a href="https://appointment.psa.gov.ph/">https://appointment.psa.gov.ph/</a> to schedule an appointment for your document request.</p>
                    </div>
                </div>
                ...
                <div class="info-box">
                    ...
                    <div class="info-details">
                        ...
                        <p>Arrive at the PSA CRS Outlet on the scheduled date and time of your appointment.</p>
                    </div>
                </div>
                ...
                <div class="info-box">
                    ...
                    <div class="info-details">
                        <h3 class="requirement">Present CRS Appointment Slip and Valid ID:</h3>
                        <p>Present the printed or electronic copy of the CRS Appointment Slip along with one valid ID.</p>
                        <p>Clients with PhilID/ePhilID requesting a Death Certificate for immediate family members can transact without an appointment.</p>
                    </div>
                </div>
                ...
                <div class="info-box">
                    ...
                    <div class="info-details">
                        <h3 class="requirement">For Authorized Representative:</h3>
                        <p>If you're an authorized representative, ensure you have: </p>
                        <p>• Valid Identity Document (ID) of the document owner (original and photocopy) with a clear photo, full name in print, signature, and issued by an official authority.</p>
                        <p>• Your own valid ID.</p>
                        <p>• CRS Appointment Slip bearing the name of the authorized representative.</p>
                    </div>
                </div>
                ...
                <div class="info-box">
                    ...
                    <div class="info-details">
                        <h3 class="requirement">If Request is at PSA Civil Registry Outlet Hosted by LGU:</h3>
                        <p>If the request for a copy issuance of a civil registry document will be availed at the PSA Civil Registry Outlet hosted by the Local Government Unit (LGU):</p>
                        <p>• Present the printed or electronic copy of the CRS Appointment Slip.</p>
                        <p>• Provide the original OR from the Local Government Unit (LGU) as proof of payment of the LGU Add-on Fee.</p>
                        <p>• Present one valid ID upon entry at the PSA Civil Registry System Outlet.</p>
                    </div>
                </div>
                ...
                <div class="info-box">
                    ...
                    <div class="info-details">
                        ...
                        <p>Pass through health and safety protocols, including allowing the Updated QR Code of the COVID19 Digital Contact Tracing App to be scanned or filling up and submitting the Health Survey Form.</p>
                        <p>Undergo temperature check.</p>
                    </div>
                </div>
                ...
                <div class="info-box">
                    ...
                    <div class="info-details">
                        ...
                        <p>Get an Application Form for Marriage Certificate (Pink Form) from the AF dispenser.</p>
                ...
                <div class="info-box">
                    ...
                    <div class="info-details">
                        ...
                        <p>First Time Job Seekers should proceed to the Public Assistance and Complaints Desk (PACD).</p>
                    </div>
                </div>
                ...
                <div class="info-box">
                    ...
                    <div class="info-details">
                        <h3 class="requirement">Payment Window:</h3>
                        <p>Proceed to the payment window and submit the AF and required documents.</p>
                        <p>Pay the corresponding fee for the request, either in cash or through online cashless payment.</p>
                        <p>Check the details in the issued Official Receipt (OR).</p>
                ...
                <div class="info-box">
                    ...
                    <div class="info-details">
                        ...
                        <p>After payment, proceed to the Releasing Area and wait while the request is being processed.</p>
                    </div>
                </div>
                ...
                <div class="info-box">
                    ...
                    <div class="info-details">
                        ...
                        <p>Wait for the name of the document owner/client to be called.</p>
                    </div>
                </div>
                ...
                <div class="info-box">
                    ...
                    <div class="info-details">
                        ...
                        <p>Once your name is called, proceed to the Releasing Window where the document owner/client’s name was called.</p>
                    </div>
                </div>
                ...
                <div class="info-box">
                    ...
                    <div class="info-details">
                        <h3 class="requirement">Present the ORIGINAL OR and Other Requirements:</h3>
                        <p>Present the ORIGINAL OR and other requirements at the Releasing Window.</p>
                        <p>First Time Jobseekers should present their claim stub at the Releasing Window.</p>
                    </div>
                </div>
                ...
                <div class="info-box">
                    ...
                    <div class="info-details">
                        ...
                        <p>Carefully examine the received document to ensure all information is accurate and complete.</p>
                    </div>
                </div>
                ...
                <div class="info-box">
                    ...
                    <div class="info-details">
                        <h3 class="requirement">Sign the “Received by” Portion:</h3>
                        <p>Sign the “Received by” portion at the back of the AF and indicate the date of receipt.</p>
                        <p>First Time Jobseekers should also sign in the control logbook.</p>
                    </div>
                </div>                
            </div>         
        </div>
        ...
        <div class="fee-info" hidden>
            <div class="no-fee">
                <p>
                    Pursuant to RA 11261, the issuance of (1) one copy of marriage certificate of a first time Jobseeker is to be issued for FREE</p> 
            </div>
            <div class="fee">
                <table>
                        <tr>
        ...
        <div class="samplephoto-info" >
            ...
            <div class="img-magnifier-container" onmouseover="magnify(reference-photo, 3)">
                <img id="reference-photo" src="/New DavHow/documents/document_images/Certificate of Marriage.jpg" alt="">
            </div>
        </div>
        ...
        <div class="reference-info">
            ...
            <div class="article-reference">
                <a href="httpswww.scribd.comdocument539644415sample-marriage-certificate-for-practice-court">Sample PSA Marriage Certificate</a>
            </div>
        </div>
    </section>
</div>
