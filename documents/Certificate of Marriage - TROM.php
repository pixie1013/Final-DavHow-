...
<head>
    ...
    <title>DavHow: Certificate of Marriage - Timely Registration</title>
...
<header class="header1">
    ...
    <section class="document-area">
        <div class="image-wrapper">
            ...
            <div class="document-text">
                <h1>MARRIAGE CERTIFICATE - Timely Registration</h1>
    ...
    <section class="information-area">
        ...
        <div class="requirement-info">
            ...
            <div class="info-box">
                <h3 class="requirement">Request Letter</h3>
                <p>If the wedding was solemnized outside the church/court, the couple must attach request letter addressed to the solemnizing officer</p>
            </div>
        </div> 
        ...
        <div class="procedure-info">
            ...
            <div class="info-box">
                ...
                <div class="info-details">
                    ...
                    <p>Pay the registration fee at the cashier's office. The fee is typically Php 250.00.</p>
                </div>
            </div>
            ...
            <div class="info-box">
                ...
                <div class="info-details">
                    ...
                    <p>After paying the registration fee, submit the Certificate of Marriage along with the Official Receipt to the appropriate authority.</p>
                </div>
            </div>
            ...
            <div class="info-box">
                ...
                <div class="info-details">
                    <h3 class="requirement">Receive Registered Certificate of Marriage:</h3>
                    <p>Once the submission is complete, wait for the processing of the marriage registration.</p>
                    <p>After processing, receive the registered Certificate of Marriage.</p>
                </div>
            </div>            
        </div>
        ...
        <div class="fee-info" hidden>
            <div class="fee">
                <table>
                        ...
                        <tr>
                            <td class="fee-location">Local Civil Registry's Cashier</td>                    
                        </tr>
                </table>
            </div>
