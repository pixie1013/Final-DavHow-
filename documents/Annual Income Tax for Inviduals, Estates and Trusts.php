...
<head>
    ...
    <title>DavHow: Annual Income Tax for Individuals, Estates, and Trusts</title>
    ...
    <section class="document-area">
        <div class="image-wrapper">
            ...
            <div class="document-text">
                <h1>ANNUAL INCOME TAX FOR INDIVIDUALS, ESTATES, AND TRUSTS</h1>
                <p>BIR Form No. 1701 shall be filed by individuals who are engaged in trade/business or the practice of profession including those with mixed income (i.e., those engaged in the trade/business or profession who are also earning compensation income) in accordance with Sec. 51 of the Code, as amended. The annual income tax return summarizes all the transactions covering the calendar year of the taxpayer.</p>
    ...
    <section class="information-area">
        ...
        <div class="requirement-info">
            <div class="info-box">
                ...
                <<p>This return shall be filed by the following individuals regardless of amount of gross income:</p>
                    <ul>
                        <li>A resident citizen engaged in trade, business, or practice of profession within and without the Philippines.</li>
                        <li>A resident alien, non-resident citizen or non-resident alien individual engaged in trade, business or practice of profession within the Philippines.</li>
                        <li>A trustee of a trust, guardian of a minor, executor/administrator of an estate, or any person acting in any fiduciary capacity for any person, where such trust, estate, minor, or person is engaged in trade or business.</li>
                        <li>An individual engaged in trade or business or in the exercise of their profession and receiving compensation income as well.</li>
                      </ul>  
            </div>
            <div class="requirement-info">
                <div class="info-box">
                    <h3 class="requirement">Certificate of Income Tax Withheld on Compensation (BIR Form 2316)</h3>
                    <p>Provide BIR Form 2316 if applicable.</p>
                </div>
            </div>
            ...
            <div class="requirement-info">
                <div class="info-box">
                    ...
                    <p>Provide BIR Form 2304 if applicable.</p>
                </div>
            </div>
            ...
            <div class="requirement-info">
                <div class="info-box">
                    ...
                    <p>Provide BIR Form 2307 if applicable.</p>
                </div>
            </div>
            ...
            <div class="requirement-info">
                <div class="info-box">
                    ...
                    <p>Provide duly approved Tax Debit Memo if applicable.</p>
                </div>
            </div>
            ...
            <div class="requirement-info">
                <div class="info-box">
                    ...
                    <p>Provide proof of Foreign Tax Credits if applicable.</p>
                </div>
            </div>
            ...
            <div class="requirement-info">
                <div class="info-box">
                    ...
                    <p>Provide Income Tax Return previously filed and proof of payment if filing an amended return for the same year.</p>
                </div>
            </div>
            
            <div class="requirement-info">
                <div class="info-box">
                    <h3 class="requirement">Account Information Form (AIF) or Certificate of the independent CPA with Audited Financial Statements</h3>
                    <p>Provide AIF or Certificate of the independent CPA with Audited Financial Statements if the gross annual sales, earnings, receipts or output exceed three million pesos (P3,000,000.00).</p>
                </div>
            </div>
            
            <div class="requirement-info">
                <div class="info-box">
                    <h3 class="requirement">Account Information Form or Financial Statements</h3>
                    <p>Provide Account Information Form or Financial Statements if the gross annual sales, earnings, receipts or output do not exceed P3,000,000.00 and is subject to graduated income tax rates under Section 24(A)(2)(a).</p>
                </div>
            </div>
            ...
            <div class="requirement-info">
                <div class="info-box">
                    ...
                    <p>Provide proof of prior year’s excess tax credits if applicable.</p>
                </div>
            </div>            
        </div>        
         ...
         <div class="procedure-info">
            <div class="subtype">
                ...
                <div class="info-box">
                    ...
                    <div class="info-details">
                        <h3 class="requirement">Fill-up applicable fields in the BIR Form No. 1701</h3>
                        <p>Complete all the necessary fields in the BIR Form No. 1701 using the downloaded Electronic Bureau of Internal Revenue Form (eBIRForm) Package.</p>
                    </div>
                </div>
                ...
                <div class="info-box">
                    ...
                    <div class="info-details">
                        ...
                        <p>Click the “Proceed to Payment” button.</p>
                        <p>Fill up the required fields in the “eFPS Payment Form”.</p>
                        <p>Click the “Submit” button to proceed with the payment.</p>
                    </div>
                </div>
                ...
                <div class="info-box">
                    ...
                    <div class="info-details">
                        ...
                        <p>Upon successful e-filing and e-payment, receive payment confirmation from eFPS-Authorized Agent Banks (eFPS-AABs).</p>
                    </div>
                </div>
            </div>            
            <div class="subtype">
                ...
                <div class="info-box">
                    ...
                    <div class="info-details">
                        <h3 class="requirement">Fill-up fields in the BIR Form No. 1701</h3>
                        <p>Complete the applicable fields in the BIR Form No. 1701 using the downloaded Electronic Bureau of Internal Revenue Form (eBIRForm) Package.</p>
                    </div>
                </div>
                ...
                <div class="info-box">
                    ...
                    <div class="info-details">
                        <h3 class="requirement">Print the duly accomplished BIR Form No. 1701</h3>
                        <p>Print the filled-out BIR Form No. 1701.</p>
                    </div>
                </div>
                ...
                <div class="info-box">
                    ...
                    <div class="info-details">
                        ...
                        <p>Go to the nearest AAB under the jurisdiction of the Revenue District Office (RDO) where you are registered.</p>
                        <p>Present the duly accomplished BIR Form No. 1701, along with the required attachments and your payment.</p>
                    </div>
                </div>
                ...
                <div class="info-box">
                    ...
                    <div class="info-details">
                        <h3 class="requirement">Alternative if no AABs are available</h3>
                        <p>If there are no AABs in your area, proceed to the Revenue Collection Officer or duly Authorized City or Municipal Treasurer within your RDO.</p>
                        <p>Present the duly accomplished BIR Form No. 1701, along with the required attachments and your payment.</p>
                    </div>
                </div>
                ...
                <div class="info-box">
                    ...
                    <div class="info-details">
                        ...
                        <p>Obtain your copy of the duly stamped and validated form from the teller of the AABs/Revenue Collection Officer/duly Authorized City or Municipal Treasurer.</p>
                    </div>
                </div>                                              
            </div>
            ...
            <div class="subtype">
                ...
                <div class="info-box">
                    ...
                    <div class="info-details">
                        <h3 class="requirement">Fill-up the BIR Form No. 1701 in triplicate copies</h3>
                        <p>Complete the required fields in the BIR Form No. 1701, preparing three copies of the form.</p>
                    </div>
                </div>
                ...
                <div class="info-box">
                    ...
                    <div class="info-details">
                        <h3 class="requirement">Proceed to the Revenue District Office (RDO) or Tax Filing Center</h3>
                        <p>Go to the RDO where you are registered or any designated Tax Filing Center established by the BIR.</p>
                    </div>
                </div>
                ...
                <div class="info-box">
                    ...
                    <div class="info-details">
                        <h3 class="requirement">Present the duly accomplished BIR Form 1701</h3>
                        <p>Submit the three copies of the duly accomplished BIR Form 1701, along with the required attachments, to the designated officer.</p>
                    </div>
                </div>
                ...
                <div class="info-box">
                    ...
                    <div class="info-details">
                        <h3 class="requirement">Receive your copy</h3>
                        <p>Obtain your copy of the duly stamped and validated form from the representative at the RDO or Tax Filing Center.</p>
                    </div>
                </div>                                  
            </div>
        </div>
        ...
        <div class="samplephoto-info" >
            ...
            <div class="img-magnifier-container" onmouseover="magnify('reference-photo', 3)">
                <img id="reference-photo" src="/New DavHow/documents/document_images/Annual Income Tax for Individuals, Estates, and Trusts.jpg" alt="">
            </div>
            <div class="img-magnifier-container" onmouseover="magnify('reference-photo-2', 3)">
                <img id="reference-photo-2" src="/New DavHow/documents/document_images/82255BIR Form 1701_pages-to-jpg-0002.jpg" alt="">
            </div>            
        </div>
        ...
        <div class="reference-info">
            ...
            <div class="article-reference">
                <a href="httpswww.bir.gov.phimagesbir_filestaxpayers_service_programs_and_monitoring_11702-RT%20Jan%202018%20ENC" target="_blank">Sample Annual Income Tax for Individuals, Estates, and Trusts</a>
            </div>
        </div>
    </section>
</div>
