...
<head>
    ...
    <title>DavHow: Marriage License</title>
    ...
    <section class="document-area">
        <div class="image-wrapper">
            ...
            <div class="document-text">
                <h1>MARRIAGE LICENSE</h1>
                <p>A legal document that states you and your partner are legally allowed to marry anywhere in the Philippines. This legal document is obtained before a couple marries.</p>
                <p>This is eligible to a person at least 18 years old.</p>
            </div>
        </div>
    </section>    
    ...
    <section class="information-area">
        ...
        <div class="requirement-info">
            <div class="eligibility-type info-box">
                ...
                <h2>Domestic Applicants</h2>
            </div>
            <div class="info-box">
                <h3 class="requirement">CENOMAR (NSO)</h3>
                <p>Required for applicants 26 years old & above</p>
            </div>
            <div class="info-box">
                <h3 class="requirement">Pre-marriage Counseling/Seminar</h3>
                <p>Required for applicants 25 years old and above</p>
            </div>
            <div class="info-box">
                <h3 class="requirement">Two (2) copies each of either one of the following:</h3>
                <p>Birth Certificate</p>
                <p>Baptismal Certificate</p>
                <p>Voter’s Affidavit</p>
                <p>School Records</p>
            </div>
            <div class="info-box">
                <h3 class="requirement">Additional Requirements Based on Age</h3>
                <p>If the applicant is 18-20 years old, bring father to sign the Parental Consent</p>
                <p>If the applicant is 21-25 years old, bring father to sign the Parental Advice</p>
            </div>
            <div class="info-box">
                <h3 class="requirement">Valid I.D. of Applicants and Parents</h3>
                <p>Photocopies of Valid I.D.s for both applicants and parents</p>
            </div>
        </div>
        ...
        <div class="requirement-info">
            <div class="eligibility-type info-box">
                <img src="/New DavHow/valid_id/icons/backto-icon.svg" alt="">
                <h2>Foreign Applicants</h2>
            </div>
            <div class="info-box">
                <h3 class="requirement">Legal Capacity to Marry</h3>
                <p>From their respective Embassy/Consulate in the Philippines</p>
            </div>
            <div class="info-box">
                <h3 class="requirement">Photocopies of Passport</h3>
                <p></p>
            </div>
        </div>
        ...
        <div class="requirement-info">
            ...
            <div class="info-box">
                <h3 class="requirement">Judicial decree of annulment and annotated marriage contract</h3>
                <p>All documents - 3 certified photocopies each, except for the certificate of authenticity which requires 1 original and 3 certified photocopies</p>
            </div>
            <div class="info-box">
                <h3 class="requirement">Valid Identification (ID) card of applicant and parents</h3>
                <p>2 photocopies</p>
            </div>
            <div class="info-box">
        ...
        <div class="requirement-info">
            <div class="eligibility-type info-box">
                <img src="/New DavHow/valid_id/icons/backto-icon.svg" alt="">
                <h2>If Divorced in Muslim</h2>
            </div>
            <div class="info-box">
                <h3 class="requirement">Order of Divorce</h3>
                <p>1 photocopy and bring the certified true copy from the original for verification</p>
            </div>
            <div class="info-box">
                <h3 class="requirement">Certificate of Finality of Order</h3>
                <p>1 photocopy and bring the certified true copy from the original for verification</p>
            </div>
            <div class="info-box">
                <h3 class="requirement">Certification from the Office of Shariah Circuit Register</h3>
                <p>1 photocopy and bring the certified true copy from the original for verification</p>
            </div>
            <div class="info-box">
                <h3 class="requirement">Certificate of Authenticity</h3>
                <p>1 photocopy and bring the certified true copy from the original for verification</p>
            </div>
            <div class="info-box">
                <h3 class="requirement">Certificate of Divorce</h3>
                <p>1 photocopy and bring the certified true copy from the original for verification</p>
            </div>
            <div class="info-box">
                <h3 class="requirement">Certificate of Conversion to Islam</h3>
                <p>1 photocopy and bring the certified true copy from the original for verification</p>
            </div>
            <div class="info-box">
                <h3 class="requirement">Annotated Marriage Contract</h3>
                <p>1 photocopy and bring the certified true copy from the original for verification</p>
            </div>
        </div>
         ...
         <div class="procedure-info">
            <div class="info-box">
                ...
                <div class="info-details">
                    <h3 class="requirement">Get a Transaction ID</h3>
                    <p>Get a transaction ID for Marriage Division at the front desk.</p>
                </div>
            </div>
            ...
            <div class="info-box">
                ...
                <div class="info-details">
                    <h3 class="requirement">Present Supporting Documents</h3>
                    <p>Present the supporting documents for evaluation to the Marriage Division staff.</p>
                </div>
            </div>
            ...
            <div class="info-box">
                ...
                <div class="info-details">
                    <h3 class="requirement">Fill Up Forms</h3>
                    <p>Fill up the necessary forms.</p>
                </div>
            </div>
            ...
            <div class="info-box">
                ...
                <div class="info-details">
                    <h3 class="requirement">Pay Application Fee</h3>
                    <p>Pay the Marriage License Application Fee of 500.00 Php at the City Treasurer’s Office (750.00 Php if foreigner).</p>
                </div>
            </div>
            ...
            <div class="info-box">
                ...
                <div class="info-details">
                    <h3 class="requirement">Submit Application Forms</h3>
                    <p>Submit filled-up application forms at the Marriage Division for review and receive a copy of the Notice of Posting.</p>
                </div>
            </div>
            ...
            <div class="info-box">
                ...
                <div class="info-details">
                    <h3 class="requirement">Return to CCRO</h3>
                    <p>Return to the City Civil Registration Office (CCRO) on the day specified in the Notice to receive the Marriage License.</p>
                </div>
            </div>            
         </div>
        ...
        <div class="location-info" hidden>
            ...
            <div class="details-container">
                ...
                <div class="location-details">
                    <strong><p>City Civil Registrar’s Office</p></strong>    
                    <table>
                        <tr>
                            <td>Address</td>
        ...
        <div class="fee-info" hidden>
            <div class="no-fee">
                <p>Domestic and Foreign Applicants have varying fees.</p> 
            </div>
            <div class="fee">
                <table>
                        <tr>
                            <strong><td class="fee-name">Marriage Application Fee</td></strong>
                            <td rowspan="2">PHP 300.00</td>
                        </tr>
                        <tr>
                            <td class="fee-location">City Civil Registrar’s Office - Window 15</td>                    
                        </tr>
                </table>
            </div>
            <div class="fee">
                <table>
                        <tr>
                            <strong><td class="fee-name">License Fees</td></strong>
            ...
            <div class="fee">
                <table>
                        <tr>
                            <strong><td class="fee-name">Legal Capacity Marriage Registration Fee (for foreign applicants)</td></strong>
            ...
            <div class="total-fee fee">
                <table>
                        <tr>
                            <td class="fee-total">Total to pay(Domestic Applicant):</td>
                            <td rowspan="2"><strong>PHP 500.00</strong></td>
                        </tr>
                </table>
            </div>
            <div class="total-fee fee">
                <table>
                        <tr>
                            <td class="fee-total">Total to pay(Foreign Applicant):</td>
                            <td rowspan="2"><strong>PHP 750.00</strong></td>
                        </tr>
                </table>
            </div>
        </div>     
        ...
        <div class="samplephoto-info" >
            ...
            <div class="img-magnifier-container" onmouseover="magnify(reference-photo, 3)">
                <img id="reference-photo" src="/New DavHow/documents/document_images/Marriage License.jpg" alt="">
            </div>
        </div>
        ...
        <div class="reference-info">
            ...
            <div class="article-reference">
                <a href="https://quezoncity.gov.ph/wp-content/uploads/2021/09/MARRIAGE-LICENCE-FORM.pdf9" target="_blank">Sample Marriage License</a>
            </div>
        </div>
    </section>
</div>
