...
<head>
    ...
    <title>DavHow: Certificate of Marriage - Delayed Registration</title>
...
<header class="header1">
    ...
    <section class="document-area">
        <div class="image-wrapper">
            ...
            <div class="document-text">
                <h1>MARRIAGE CERTIFICATE - Delayed Registration</h1>
                <p>A Certificate of Marriage is an official document provided by a government authority, confirming the legal union between a couple. It includes details such as the names of the spouses, the date and location of the marriage, and often the signatures of witnesses and officiants. This certificate serves as legal proof of marriage and is required for various administrative processes, including name changes and accessing spousal benefits.</p>
            </div>
        </div>
    </section>    
    ...
    <section class="information-area">
        ...
        <div class="requirement-info">
            <div class="info-box">
                <h3 class="requirement">Filled up Certificate of Marriage (COM)</h3>
                <p></p>
            </div>
            <div class="info-box">
                <h3 class="requirement">Affidavit of delayed registration</h3>
                <p></p>
            </div>
            <div class="info-box">
                <h3 class="requirement">Joint affidavit of two witnesses</h3>
                <p></p>
            </div>
            <div class="info-box">
                <h3 class="requirement">Certification from the solemnizing office</h3>
                <p></p>
            </div>
            <div class="info-box">
                <h3 class="requirement">Negative result from PSA</h3>
                <p></p>
            </div>
        </div>        
        ...
        <div class="procedure-info">
            <div class="info-box">
                ...
                <div class="info-details">
                    <h3 class="requirement">Submit Required Documents for Review/Evaluation:</h3>
                    <p>Proceed to the Marriage Division and submit all required documents for review and evaluation.</p>
                </div>
            </div>
            ...
            <div class="info-box">
                ...
                <div class="info-details">
                    <h3 class="requirement">Pay Necessary Fees:</h3>
                    <p>Pay the necessary fees for late registration as per the prescribed fee schedule.</p>
                </div>
            </div>
            ...
            <div class="info-box">
                ...
                <div class="info-details">
                    <h3 class="requirement">Submit Certificate of Marriage with Official Receipt:</h3>
                    <p>After paying the necessary fees, submit the Certificate of Marriage along with the Official Receipt to the Marriage Division.</p>
                </div>
            </div>
            ...
            <div class="info-box">
                ...
                <div class="info-details">
                    ...
                    <p>Upon submission, receive an issued claim stub.</p>
        ...
        <div class="fee-info" hidden>
            <div class="fee-info" hidden>
                <div class="no-fee">
                    <p>Fees vary based on how many months and/or a year a marriage occured before registering</p> 
                </div>
                <div class="fee">
                    <table>
                            <tr>
                                <strong><td class="fee-name">More than 15 calendar days (with marriage license)</td></strong>
                ...
                <div class="fee">
                    <table>
                            <tr>
                                <strong><td class="fee-name">More than 30 calendar days (cohabitation, Muslim, tribal rites, Art 27 and Art 38)</td></strong>
                                <td rowspan="2">Php 300.00</td>
                            </tr>
                            <tr>
                                <td class="fee-location">City Treasurer’s Office</td>                    
                ...
                <div class="fee">
                    <table>
                            <tr>
                                <strong><td class="fee-name">6 months to 11 months</td></strong>
                ...
                <div class="fee">
                    <table>
                            <tr>
                                <strong><td class="fee-name">One (1) year or more</td></strong>
                                <td rowspan="2">Php 400.00 </td>
                            </tr>
                            <tr>
                                <td class="fee-location">City Treasurer’s Office</td>                    
                            </tr>
        ...
        <div class="samplephoto-info" >
            ...
            <div class="img-magnifier-container" onmouseover="magnify(reference-photo, 3)">
                <img id="reference-photo" src="/New DavHow/documents/document_images/Certificate-of-Marriage-_page-0001.jpg" alt="">
            </div>
            <div class="img-magnifier-container" onmouseover="magnify(reference-photo, 3)">
                <img id="reference-photo" src="/New DavHow/documents/document_images/Certificate-of-Marriage-_page-0002.jpg" alt="">
            </div>
        </div>
        ...
        <div class="reference-info">
            ...
            <div class="article-reference">
                <a href="httpspsa.gov.phsitesdefaultfilesss_ssdBS1%20-%201%20-%20Ms.%20Marizza%20Grande.pdf" target="_blank">Sample Certificate of Marriage</a>
            </div>
        </div>
    </section>
</div>
