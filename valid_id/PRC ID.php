    ...
    <div class="whole-document-area">
        <section class="document-area">
            <div class="image-wrapper">
                ...
                <div class="document-text">
                    <h1>Professional Regulatory Commission (PRC) ID</h1>
                    <p>
                        The Professional Regulation Commission (PRC) ID is an identification card for registered professionals.
                        It is proof of legal authority <br> to perform certain services aligned with their profession. 
                        This may be used for transactions with government agencies, banks, and other institutions.           
                    </p>
                </div>
            </div>
        </section>    
        ...
        <section class="information-area">
            ...
            <div class="requirement-info">
                <div class="info-box">
                    <h3 class="requirement">Notice of Admission</h3>
                    <p></p>
                </div>
                <div class="info-box">
                    <h3 class="requirement">Two (2) passport-sized pictures with white background</h3>
                    <p></p>
                </div>
            </div> 
            <div class="requirement-info">
                <div class="info-box">
                    <h3 class="requirement">Two (2) sets of documentary stamps from the Customer Service Center of PRC site</h3>
                    <p></p>
                </div>
                <div class="info-box">
                    <h3 class="requirement">Accomplished <a rel="noopener noreferrer" target="_blank" href="https://www.prc.gov.ph/uploaded/documents/rd%20oath%20form.pdf">Oath Form</a></h3>
                    <p></p>
                </div>
            </div> 
            <div class="requirement-info">
                <div class="info-box">
                    <h3 class="requirement">Community Tax Certificate or Cedula</h3>
                    <p></p>
                </div>
            </div>              
            ...
            <div class="procedure-info">
                <div class="subtype">
                    <div class="subtype-text">
                        ...
                        <strong><p>ONLINE and WALK-INS</p></strong>   
                    </div>
                    <div class="info-box">
                        ...
                        <div class="info-details">
                            <h3 class="requirement">Access LERIS</h3>
                            <p>Visit the <a rel="noopener noreferrer" target="_blank" href="https://online.prc.gov.ph/">Licensure Examination & Registration Information System</a> (LERIS).</p>
                        </div>
                    </div>
                    <div class="info-box">
                        <div class="circle-background">
                        ...
                        <div class="info-details">
                            <h3 class="requirement">Login or Register for LERIS</h3>
                            <p>Login using your old account used from the examination or register for a new LERIS account; the following information is needed:
                                <ul>
                                    <li>Email Address</li>
                                    <li>Mobile number</li>
                                    <li>Personal data</li>
                                    <li>ID photo (.jpg)</li>
                                    <li>Valid ID Card or Cedula</li>
                                </ul>
                            </p>
                        </div>
                    </div>
                    <div class="info-box">
                        ...
                        <div class="info-details">
                            <h3 class="requirement">Register for an Account</h3>
                            <p>Then, the user may register for an account which requires personal information and a password.</p>
                        </div>
                    </div>
                    <div class="info-box">
                        <div class="circle-background">
                        ...
                        <div class="info-details">
                            <h3 class="requirement">Sign In</h3>
                            <p>Sign in using your username (email address) and password.</p>
                        </div>
                    </div>
                    <div class="info-box">
                        <div class="circle-background">
                        ...
                        <div class="info-details">
                            <h3 class="requirement">Fill Out Necessary Details</h3>
                            <p>Fill out the necessary details asked and double-check when finished. The following are required:
                                <ul>
                                    <li>Citizenship</li>
                                    <li>Birthplace</li>
                                    <li>Address</li>
                                    <li>Town/City, Province</li>
                                    <li>Mobile number</li>
                                    <li>Telephone number</li>
                                    <li>Parent's full name and citizenship</li> 
                                    <li>School origin</li>
                                    <li>Course</li>
                                    <li>Date of Graduation</li>
                                    <li>Valid ID number and details</li>
                                </ul>
                            </p>
                        </div>
                    </div>
                    <div class="info-box">
                        ...
                        <div class="info-details">
                            <h3 class="requirement">Upload Photo</h3>
                            <p>When uploading the photo, read the photo requirements and guidelines.</p>
                        </div>
                    </div>
                    <div class="info-box">
                        <div class="circle-background">
                        ...
                        <div class="info-details">
                            <h3 class="requirement">Select Transaction</h3>
                            <p>Select transaction, then click on Initial Registration. Select Profession, then input your Application Number and click confirm.</p>
                        </div>
                    </div>
                    <div class="info-box">
                        <div class="circle-background">
                        ...
                        <div class="info-details">
                            <h3 class="requirement">Schedule Appointment and Payment</h3>
                            <p>Schedule an appointment and select your preferred payment method. The available options for payment methods are:
                                <ul>
                                    <li>Maya</li>
                                    <li>Credit or debit card</li>
                                    <li>BancNet, GGCash, or LANDBANK</li>
                                    <li>UCPB (over the counter, UCPB Connect, or via the Mobile App)</li>
                                    <li>In person at a PRC cashier</li>
                                </ul>
                            </p>
                        </div>
                    </div>
                    <div class="info-box">
                        ...
                        <div class="info-details">
                            <h3 class="requirement">Pay Registration Fee</h3>
                            <p>Pay for the initial registration fee for online transactions and review your transaction summary.</p>
                        </div>
                    </div>
                    <div class="info-box">
                        <div class="circle-background">
                        ...
                        <div class="info-details">
                            <h3 class="requirement">Print Transaction Details</h3>
                            <p>Print Transaction Details on your profile page.</p>
                        </div>
                    </div>
                    <div class="info-box">
                        <div class="circle-background">
                        ...
                        <div class="info-details">
                            <h3 class="requirement">Print Oath Form</h3>
                            <p>Print the Oath Form by clicking Existing Transactions and then Payment details.</p>
                        </div>
                    </div>
                    <div class="info-box">
                        <div class="circle-background">
                        ...
                        <div class="info-details">
                            <h3 class="requirement">Visit PRC Regional Office</h3>
                            <p>Proceed to the PRC Regional Office on your appointment schedule.</p>
                        </div>
                    </div>
                    <div class="info-box">
                        <div class="circle-background">
                        ...
                        <div class="info-details">
                            <h3 class="requirement">Obtain Documentary Stamps</h3>
                            <p>Obtain two documentary stamps for your Oath Form and Registration Certificate at the Customer Service Center.</p>
                        </div>
                    </div>
                    <div class="info-box">
                        <div class="circle-background">
                        ...
                        <div class="info-details">
                            ...
                            <p>Submit your requirements and sign on the registry sheet.</p>
                        </div>
                    </div>
                    <div class="info-box">
                        <div class="circle-background">
                        ...
                        <div class="info-details">
                            <h3 class="requirement">Receive ID Claim Slip</h3>
                            <p>Once the ID claim slip is received, revisit the same PRC branch on the date indicated.</p>
                        </div>
                    </div>
                    <div class="info-box">
                        <div class="circle-background">
                        ...
                        <div class="info-details">
                            <h3 class="requirement">Receive PRC ID</h3>
                            <p>Receive your PRC ID and Certification of Registration within the day.</p>
                        </div>
                    </div>
                    <div class="info-box">
                        <div class="circle-background">
                        ...
                        <div class="info-details">
                            <h3 class="requirement">Attend Online Oath-Taking</h3>
                            <p>Attend the online oath-taking ceremonies.</p>
                        </div>
                    </div>
                </div>
                ...
                <div class="subtype">
                    ...
                    <div class="info-box">
                        ...
                        <div class="info-details">
                            <h3 class="requirement">Sign In and Fill Out Information</h3>
                            <p>Similar to new applicant registration, sign in and fill out the necessary information.</p>
                        </div>
                    </div>
                    <div class="info-box">
                        <div class="circle-background">
                        ...
                        <div class="info-details">
                            <h3 class="requirement">Select Transaction for Renewal</h3>
                            <p>Select transaction for renewal.</p>
                        </div>
                    </div>
                    <div class="info-box">
                        <div class="circle-background">
                        ...
                        <div class="info-details">
                            ...
                            <p>Set your preferred appointment.</p>
                        </div>
                    </div>
                    <div class="info-box">
                        <div class="circle-background">
                        ...
                        <div class="info-details">
                            <h3 class="requirement">Pay Fees</h3>
                            <p>Pay for the necessary fees.</p>
                        </div>
                    </div>
                    <div class="info-box">
                        <div class="circle-background">
                        ...
                        <div class="info-details">
                            <h3 class="requirement">Submit and Confirm Shipment</h3>
                            <p>Click submit and confirm your shipment details.</p>
                        </div>
                    </div>                    
                </div>
            </div>
            ...
            <div class="location-info">
                <iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3959.6226128015865!2d125.5888544748877!3d7.053553392948802!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x32f96c30545f7567%3A0x78d81f64ec93cf08!2sProfessional%20Regulation%20Commission%20Region%20XI!5e0!3m2!1sen!2sph!4v1716540474884!5m2!1sen!2sph" width="600" height="450" style="border:0;" allowfullscreen="" loading="lazy" referrerpolicy="no-referrer-when-downgrade"></iframe>
                <div class="details-container">
                    <!-- LIST OF LOCATIONS -->
                    <div class="location-details">
                        <strong><p>Professional Regulation Commission Region XI</p></strong>                 
                        <p>Calamansi St. cor. First St. (beside the Indonesian Consulate) Juna Subdivision, Matina, Davao City</p>
                    </div>
            ...
            <div class="fee-info" hidden>
                <div class="fee">
                    <table>
                            <tr>
                                <strong><td class="fee-name">Application Fee</td></strong>
                                <td rowspan="2">PHP 250.00</td>
                            </tr>
                            <tr>
                                <td class="fee-location">Professional Regulation Commission Region XI</td>                    
                            </tr>
                    </table>
                </div>
                <div class="total-fee fee">
                    <table>
                            <tr>
                                ...
                                <td rowspan="2"><strong>PHP 250.00</strong></td>
                            </tr>
                    </table>
                </div>
            </div>     
            ...
            <div class="samplephoto-info">
                ...
                <div class="img-magnifier-container">
                    <img id="reference-photo" src="id photos/prc id.jpg" alt="">
                </div>
            </div>
            ...
            <div class="reference-info">
                <div class="article-reference">
                    <a rel="noopener noreferrer" target="_blank" href="https://www.teachpinas.com/prc-initial-registration-how-to-claim-prc-license/">PRC Initial Registration: How to Claim PRC ID for new passers</a>
                </div>
                <div class="article-reference">
                    <a rel="noopener noreferrer" target="_blank" href="https://www.moneymax.ph/government-services/articles/prc-id">How to Get a PRC ID in 2023: Complete Guide for New Professionals</a>
                </div>
                <div class="article-reference">
                    <a rel="noopener noreferrer" target="_blank" href="https://newstogov.com">Sample PRC ID</a>
                </div>
            </div>
        </section>
    </div>
