...
<head>
    ...
    <title>DavHow: PhilHealth ID</title>
    ...
    <div class="whole-document-area">
        <section class="document-area">
            <div class="image-wrapper">
                ...
                <div class="document-text">
                    <h1>PHILHEALTH ID</h1>
                    <p>
                        The PhilHealth ID is a valid identification card from the Philippine Health Insurance Corporation (PHIC) that seeks to assist Filipino citizens in healthcare. 
                        It has no expiry membership for at least 21-year-old Filipinos who are not allowed as dependents. Holders are eligible for PhilHealth benefits and privileges by the government's insurance program.            
                    </p>
                </div>
            </div>
        </section>    
        ...
        <section class="information-area">
            ...
            <div class="requirement-info">
                <div class="info-box">
                    <h3 class="requirement">Two (2) signed copies of the PhilHealth Member Registration Form (PMRF)</h3>
                </div>
                <div class="info-box">
                    <h3 class="requirement">Two (2) latest 1 x 1 ID pictures</h3>
                </div>
                <div class="info-box">
                    <h3 class="requirement">Two (2) valid ID documents</h3>
                </div>
                <div class="info-box">
                    <h3 class="requirement">A copy of a <a href="../documents/Birth-Certificate.html">PSA-issued birth certificate</a> or <a href="../documents/Marriage Certificate.html">Marriage Certificate</a> for the married-female applicant.</h3>
                </div>
            </div> 
            ...
            <div class="procedure-info">
                <div class="subtype">
                    <div class="info-box">
                        ...
                        <div class="info-details">
                            <h3 class="requirement">Visit the nearest branch</h3>
                            <p>Visit your nearest PhilHealth office and complete the request form for a PhilHealth Identification Card (PIC).</p>
                        </div>
                    </div>
                    <div class="info-box">
                        <div class="circle-background">
                        ...
                        <div class="info-details">
                            <h3 class="requirement">Submit the requirements.</h3>
                    ...
                    <div class="info-box">
                        ...
                        <div class="info-details">
                            <h3 class="requirement">Verification</h3>
                            <p>When the Member’s Data Record (MDR) and PhilHealth are processed, double-check the information and claim your ID.</p>
                        </div>
                    </div>
                </div>
                <div class="subtype">
                ...
                <div class="info-box">
                    ...
                    <div class="info-details">
                        ...
                        <p>Dependent beneficiaries from PhilHealth members, self-employed, and currently employed citizens who needs to update their coverage are eligible 
                            for renewal of PhilHealth membership.</p>
                    </div>
                </div>
                <div class="info-box">
                    <div class="circle-background">
                ...
                <div class="info-box">
                    ...
                    <div class="info-details">
                        <h3 class="requirement">Onsite inquiry</h3>
                ...
                <div class="info-box">
                    ...
                    <div class="info-details">
                        <h3 class="requirement">Supply necessary information</h3>
                ...
                <div class="info-box">
                    ...
                    <div class="info-details">
                        <h3 class="requirement">Submit the documents</h3>
                ...
                <div class="info-box">
                    ...
                    <div class="info-details">
                        <h3 class="requirement">Proof of Transaction</h3>
                        <p>A receipt of renewed membership will be given as a proof of transaction.</p>
                    </div>
                </div>
            </div>
            ...
            <div class="location-info">
                <iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3959.546412947447!2d125.60517507488754!3d7.062458992940039!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x32f96d7f3db7e475%3A0xb612c3b3e9c40294!2sPhilHealth%20Regional%20Office%20XI!5e0!3m2!1sen!2sph!4v1716538968189!5m2!1sen!2sph" width="600" height="450" style="border:0;" allowfullscreen="" loading="lazy" referrerpolicy="no-referrer-when-downgrade"></iframe>                
                <div class="details-container">
                    <!-- LIST OF LOCATIONS -->
                    <div class="location-details">
                        <strong><p><a target=”_blank” href="https://g.co/kgs/JySgZG">PhilHealth Regional Office XI</a></p></strong>                 
                        <p>Bolton St, Poblacion District, Davao City, Davao del Sur</p>
                    </div>
            ...
            <div class="fee-info" hidden>
                <div class="fee">
                    <table>
                            <tr>
                                <strong><td class="fee-name">Renewal Fee</td></strong>
                                <td rowspan="2">Not specified</td>
                            </tr>
                            <tr>
                                <td class="fee-location">PhilHealth Office</td>                    
                            </tr>
                    </table>
                </div>
            ...
            <div class="samplephoto-info">
                ...
                <div class="img-magnifier-container">
                    <img id="reference-photo" src="id photos/philhealth id.jpg" alt="">
                </div>
            </div>
            ...
            <div class="reference-info">
                <div class="article-reference">
                    <a target="_blank" href="https://www.moneymax.ph/government-services/articles/philhealth-online-registration">PhilHealth Online Registration Guide: How to Register as a New Member</a>
                </div>
                <div class="article-reference">
                    <a target="_blank" href="https://web.z.com/ph/blog/how-to-get-a-philhealth-id-easily-step-by-step-guide/">How to Get a PhilHealth ID Easily: Step-By-Step Guide</a>
                </div>
                <div class="article-reference">
                    <a target="_blank" href="https://www.eezi.com/philhealth-id-in-the-philippines/#:~:text=To%20get%20a%20PhilHealth%20PVC,Insurance%20or%20any%20PhilHealth%20branch">How to Get a PhilHealth ID in the Philippines?</a>
                </div>
            </div>
        </section>
    </div>
