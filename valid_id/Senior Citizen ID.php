...
<head>
    ...
    <title>DavHow: Senior Citizen's ID</title>
    ...
    <div class="whole-document-area">
        <section class="document-area">
            <div class="image-wrapper">
                ...
                <div class="document-text">
                    ...
                    <p>
                        The OSCA (Office of Senior Citizen Affairs) ID, also known as Senior Citizen ID, is a valid identification card with no expiration <br> for Filipinos aged 60 years and above.
                        Seniors with dual citizenship are also eligible to apply by providing proof of  Filipino citizenship <br> and at least six months of residency in the Philippines. 
                        Holders may avail of healthcare privileges, transportation benefits, utility <br> discounts, and taxation. However, these privileges can still be enjoyed without the ID by presenting any government-issued ID.             
                    </p>
                </div>
            </div>
        </section>    
        ...
        <section class="information-area">
            ...
            <div class="requirement-info">
                <div class="info-box">
                    <h3 class="requirement"><a href="../documents/Birth-Certificate.html">Birth certificate</a></h3>
                </div>
                <div class="info-box">
                    <h3 class="requirement">1X1 ID picture</h3>
                </div>
                <div class="info-box">
                    <h3 class="requirement">Valid government-issued ID</h3>
                </div>
                <div class="subtype">
                    <div class="category">       
                    ...
                    <div class="info-box">
                        <h3 class="requirement">Accomplished application form</h3>
                    </div>
                    <div class="info-box">
                        <h3 class="requirement">Valid ID or a Barangay Certificate of Residency</h3>
                    </div>
                    <div class="info-box">
                        <h3 class="requirement">Two (2) copies of 1x1 photo</h3>
                    </div>
                    <div class="info-box">
            ...
            <div class="procedure-info">
                <div class="info-box">
                    ...
                    <div class="info-details">
                        <h3 class="requirement">Visit OSCA</h3>
                        <p>Visit the nearest Office for Senior Citizens Affairs (OSCA) in your area in Davao City.</p>
                    </div>
                </div>
                <div class="info-box">
                    <div class="circle-background">
                    ...
                    <div class="info-details">
                        <h3 class="requirement">Prepare Supporting Documents</h3>
                        <p>Upon submission of requirements, prepare more supporting documents that will verify the applicant's eligibility for application. This may be a photocopy of your address proof, other government-issued IDs, and a Marriage Certificate/ Contract, depending on the documents specified by the local jurisdiction.</p>
                    </div>
                </div>
                <div class="info-box">
                    <div class="circle-background">
                    ...
                    <div class="info-details">
                        <h3 class="requirement">Walk-in Application</h3>
                        <p>Applicants may apply through walk-ins or online. For walk-ins, request an application and fill out the necessary details:</p>
                        <ul>
                            <li>District</li>
                            <li>Barangay</li>
                            <li>Complete name</li>
                ...
                <div class="info-box">
                    ...
                    <div class="info-details">
                        ...
                        <p>Submit the requirements and wait for the card to be issued.</p>
                    </div>
                </div>
                <div class="info-box">
                    <div class="circle-background">
                    ...
                    <div class="info-details">
                        ...
                        <p>For online registration, visit the <a target="_blank" href="https://seniorcitizen.davaocity.gov.ph/index.php/online-id-regsitration/">official site of the OSCA</a> and select your District.</p>
                    </div>
                </div>
                <div class="info-box">
                    <div class="circle-background">
                    ...
                    <div class="info-details">
                        <h3 class="requirement">Supply Required Information</h3>
                        <p>Supply the required information, which includes:</p>
                        <ul>
                            <li>Full Name</li>
                            <li>Address</li>
                            ...
                            <li>Name of Senior Association (required)</li>
                ...
                <div class="info-box">
                    ...
                    <div class="info-details">
                        <h3 class="requirement">Upload Documents</h3>
                        <p>Upload the following file requirements and click Submit Application:</p>
                        <ul>
                            <li>2 Pieces 1"x1" ID Picture with collar</li>
                            <li>Proof of Age, any of the following:
                                <ul>
                                    <li>Birth Certificate</li>
                                    <li>Baptismal Certificate</li>
                                    <li>Government Issued ID with Birthdate and Mailing Address</li>
                                    <li>Proof of Residency: Barangay Certificate with Inclusion of Date of Birth</li>
                                    <li>For Replacement: 2 Pieces 1"x1" ID Picture with collar/ Barangay Certificate (if applicable)</li>
                                </ul>
                            </li>
                            <li>Check your email address for further instructions. Note that the processing time is within five (5) business days.</li>
                        </ul>
                    </div>
                </div>                
                <div class="subtype">
                    ...
                    <div class="info-box">
                        ...
                        <div class="info-details">
                            <h3 class="requirement">Visit PhilHealth Office</h3>
                            <p>Visit the nearest PhilHealth office.</p>
                        </div>
                    </div>
                    <div class="info-box">
                        <div class="circle-background">
                        ...
                        <div class="info-details">
                            <h3 class="requirement">Fill Out Renewal Form</h3>
                            <p>Fill out a renewal form.</p>
                        </div>
                    </div>
                    <div class="info-box">
                        <div class="circle-background">
                        ...
                        <div class="info-details">
                            ...
                            <p>Attach and submit the required documents to the PhilHealth officer.</p>
                        </div>
                    </div>
                    <div class="info-box">
                        <div class="circle-background">
                        ...
                        <div class="info-details">
                            <h3 class="requirement">Pay Renewal Fee</h3>
                            <p>Pay for the renewal fee, if applicable.</p>
                        </div>
                    </div>
                    <div class="info-box">
                        <div class="circle-background">
                        ...
                        <div class="info-details">
                            <h3 class="requirement">Receive Receipt</h3>
                            <p>A receipt of renewed membership will be given as proof of transaction.</p>
                        </div>
                    </div>                    
                </div>
            </div>
            ...
            <div class="location-info">
                <iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d63353.9620527723!2d125.55022952483905!3d7.053551580688119!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x32f96d7f4c8e1b35%3A0x8d93b93c161f9d67!2sDavao%20City%20Hall%20Annex%20Building!5e0!3m2!1sen!2sph!4v1716541461977!5m2!1sen!2sph" width="600" height="450" style="border:0;" allowfullscreen="" loading="lazy" referrerpolicy="no-referrer-when-downgrade"></iframe>
                <iframe hidden src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3959.5416297273664!2d125.60635182488757!3d7.063017642939499!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x32f96d78c3b74ad1%3A0xca167ddb783330bc!2sCity%20Social%20Welfare%20and%20Development%20Office!5e0!3m2!1sen!2sph!4v1716541499305!5m2!1sen!2sph" width="600" height="450" style="border:0;" allowfullscreen="" loading="lazy" referrerpolicy="no-referrer-when-downgrade"></iframe>
                <iframe hidden src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3959.915931049569!2d125.49508147488709!3d7.019167892982466!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x32f90d3168cec4ad%3A0x44a884001694f041!2sOffice%20for%20Senior%20Citizen%20Affairs!5e0!3m2!1sen!2sph!4v1716541534451!5m2!1sen!2sph" width="600" height="450" style="border:0;" allowfullscreen="" loading="lazy" referrerpolicy="no-referrer-when-downgrade"></iframe>
                <div class="details-container">
                    <!-- LIST OF LOCATIONS -->
                    <div class="location-details">
                        <strong><p>District 1 Office</p></strong>                 
                        <p>OSCA Annex I, G/F SP Bldg., Magallanes Street, Davao City</p>
                    </div>
                    <div class="location-details">
                        <strong><p>District 2 OFfice</p></strong>                 
                        <p>G/F CSWDO Bldg., Magallanes Street, Davao City</p>
                    </div>
                    <div class="location-details" >
                        <strong><p>District 3 OFfice</p></strong>                 
                        <p>OSCA Main Toril, Cong. F.G. Datol Jr. Bldg., Agon St., Toril, Davao City</p>
                    </div>
            ...
            <div class="samplephoto-info">
                ...
                <div class="img-magnifier-container">
                    <img id="reference-photo" src="id photos/senior citizen_s card.png" alt="">
                </div>
            </div>
            ...
            <div class="reference-info">
                <div class="article-reference">
                    <a target="_blank" href="https://seniorcitizen.davaocity.gov.ph/index.php/online-id-regsitration/">Online ID registration</a>
                </div>
                <div class="article-reference">
                    <a target="_blank" href="https://www.pacificprime.com/blog/how-to-apply-for-osca-id-in-philippines.html">How To Apply For OSCA ID Or Senior Citizen Card In The Philippines</a>
                </div>
                <div class="article-reference">
                    <a target="_blank" href="https://www.zigguratrealestate.ph/post/how-to-avail-of-the-privileges-for-the-senior-citizen-in-the-philippines#:~:text=Apply%20for%20a%20senior%20citizen,avail%20of%20senior%20citizen%20privileges ">How to avail of the privileges for the senior citizen in the Philippines? </a>
                </div>
                <div class="article-reference">
                        <a target="_blank" href="https://i0.wp.com">Senior Citizen's ID</a>
                </div>
            </div>
        </section>
    </div>
