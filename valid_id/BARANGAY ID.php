...
<head>
    ...
    <title>DavHow: Barangay ID</title>
    ...
    <div class="whole-document-area">   
        <section class="document-area">
            <div class="image-wrapper">
                ...
                <div class="document-text">
                    <h1>BARANGAY ID</h1>
                    <p>
                        The Barangay ID is a proof of residence that can be used a valid 
                        government-issued ID for financial loans, applications, and clearances. <br>
                        However, it cannot be used as a substitute for other government IDs and its validity depends upon the date of issuance. 
                    </p>
                </div>
            </div>
        </section>    
        ...
        <section class="information-area">
            ...
            <div class="requirement-info">
                <div class="info-box">
                    <h3 class="requirement"><a href="">Birth certificate</a></h3>
                </div>
                <div class="info-box">
                    <h3 class="requirement">Proof of residency</h3>
                </div>
                <div class="info-box">
                    <h3 class="requirement">1x1 or 2x2 formal picture</h3>
                </div>
                <div class="info-box">
                    <h3 class="requirement">Certificate of employment</h3>
                    <p>If you work on the same barangay, present a certificate from your last employer.</p>
                </div>
            </div> 
            ...
            <div class="procedure-info">
                <div class="info-box">
                    ...
                    <div class="info-details">
                        <h3 class="requirement">Inquire at the Barangay Hall</h3>
                        <p>Visit your nearest Barangay Hall and inquire on the Barangay secretary.</p>
                    </div>
                </div>
                <div class="info-box">
                    <div class="circle-background">
                    ...
                    <div class="info-details">
                        <h3 class="requirement">Complete the Application Form</h3>
                        <p>State your purpose of application then fill out the application form. The following are the information needed:<br>
                            <ul style="margin-left: 10px;">
                                <li>Full name</li>
                                <li>Address</li>
                                <li>Contact details</li>
                                <li>Parent's information</li>
                ...
                <div class="info-box">
                    ...
                    <div class="info-details">
                        <h3 class="requirement">Submission of documents</h3>
                        <p>Submit your documents and pay for the fee, depending upon the barangay.</p>
                    </div>
                </div>
                <div class="info-box">
                    <div class="circle-background">
                    ...
                    <div class="info-details">
                        <h3 class="requirement">Wait for Approval</h3>
                        <p>Upon approval, wait for the release of your ID.</p>
                    </div>
                </div>
            </div>
            ...
            <div class="fee-info" hidden>
                <div class="fee">
                    <table>
                            ...
                            <tr>
                                <td class="fee-location">Barangay Office</td>                    
                            </tr>
                    </table>
                </div>
            ...
            <div class="samplephoto-info">
                ...
                <div class="img-magnifier-container">
                    <img id="reference-photo" src="id photos/brgy id.png" alt="">
                </div>
            </div>
            ...
            <div class="reference-info">
                <div class="article-reference">
                    <a target="_blank" rel="noopener noreferrer" href="https://www.smartparenting.com.ph/life/home/how-to-get-a-barangay-clearance-a1856-20210101">How to get a Barangay Clearance</a>
                </div>
                <div class="article-reference">
                    <a target="_blank" rel="noopener noreferrer" href="https://digido.ph/articles/what-is-barangay-id">What is barangay ID</a>
                </div>
                <div class="article-reference">
                    <a target="_blank" rel="noopener noreferrer" href="https://eu-central.storage.cloudconvert.com">Sample Barangay ID</a>
                </div>
            </div>
        </section>
    </div>
