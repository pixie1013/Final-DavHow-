    ...
    <div class="whole-document-area">
        <section class="document-area">
            <div class="image-wrapper">
                ...
                <div class="document-text">
                    <h1>PhilPost POSTAL ID</h1>
                    <p>
                        The PhilPost POSTAL ID is a legal primary identification issued by the state-owned Philippine Postal Corporation. 
                        It is usually used for postal transactions, banking, and in general, a verification of an identity. The improved version of the Postal ID features a biometrics-based 
                        uniqueness tests that ensures its identity. For Filipinos who are foreign residents with Special Retiree’s Resident Visa (SRRV), its validity lasts for three (3) years while foreign residents may enjoy its benefits for one (1) year.
                    </p>
                </div>                
            </div>
        </section>    
        ...
        <section class="information-area">
            ...
            <div class="requirement-info">
                <div class="subtype">
                    <div class="category">       
                        ...
                        <strong><p>FOR FILIPINO CITIZENS</p></strong>
                    </div>
                    <div class="info-box">
                        <h3 class="requirement">Two (2) copies of duly-accomplished <a rel="noopener noreferrer" href="https://www.postalidph.com/uploads/5/8/5/0/58500909/pid_application_form.pdf" target="_blank">PID Application Form</h3>
                        <p></p>
                    </div>
                    <div class="info-box">
                        <h3 class="requirement">Proof of Identity</h3>
                        <p>Submit any of the following:</p>
                        <ul>
                            <li><a href="../documents/Birth-Certificate.html">Birth Certificate Issued by NSO</a> or Local Civil Registry</li>
                            <li><a href="GSIS UMID Card.html">GSIS</a> or <a href="SSS UMID ID.html">SSS</a> UMID Card</li>
                            <li>Valid <a href="Drivers-License.html">Driver’s License</a></li>
                            <li>Valid <a href="Passport ID.html">Passport</a></li>
                            <li>Marriage Contract for Married Women (Only if documents and IDs submitted do not bear the married name)</li>
                        </ul>
                    </div>
                    <div class="info-box">
                        <h3 class="requirement">Proof of Address</h3>
                        <p>Submit any of the following:</p>
                        <ul class="text">
                            <li>Barangay Certificate of Residency issued within three (3) months prior to PID application</li>
                            <li>Certified True Copy of Lease</li>
                            <li>Certified True Copy of Titles issued by the Land Registration Authority (LRA)</li>
                            <li>Certified True Copy of Real Estate Tax Receipt</li>
                            <li>Bank Statement</li>
                            <li>Credit Card Statement</li>
                            <li>School Billing Statement</li>
                            <li>Utility Bill (cable, electric, internet, landline, telephone, water)</li>
                        </ul>
                    </div>
                </div>
                <div class="subtype">
                    <div class="category">       
                        <img src="icons/backto-icon.svg" alt="">
                        <strong><p>FOR FOREIGN RESIDENTS</p></strong>
                    </div>
                    <div class="info-box">
                            <h3 class="requirement">Passport</h3>
                            <p>It must be valid for at least six (6) months prior to application.</p>
                    </div>
                    <div class="info-box">
                        <h3 class="requirement">PROOF OF IDENTITY</h3>
                        <p>Any one (1) of the following documents relative to the stay in the Philippines valid for at least six (6) months prior to application:</p>
                        <ul>
                            <li>Alien Certificate of Registration Identity Card (ACRI-Card)</li>
                            <li>Long Stay Visitor Visa Extension (LSVVE)</li>
                    ...
                    <div class="info-box">
                        ...
                        <ul class="text">
                            <li>Barangay Certificate of Residency – issued within three (3) months prior to PID application</li>
                            <li>Certification or statement of account from hotel, transient home, or any temporary residence within three (3) months prior to application</li>
                            <li>Certification from hotel, transient home, or any temporary residence within three (3) months prior to application</li>
                            <li>Notarized, if applicable, Land, House, or Condominium Lease Contract</li>
                            <li>Bank Statement</li>
                            <li>Credit Card Statement</li>
                            <li>School Billing Statement</li>
                            <li>Utility Bill (cable, electric, internet, landline, telephone, water)</li>
            ...
            <div class="procedure-info">
                <div class="info-box">
                    ...
                    <div class="info-details">
                        <h3 class="requirement">Supply the necessary information</h3>
                ...
                <div class="info-box">
                    ...
                    <div class="info-details">
                        ...
                        <p>Visit the nearest ID capturing station in Davao City and submit your requirements.</p>
                    </div>
                </div>
                <div class="info-box">
                    <div class="circle-background">
                    ...
                    <div class="info-details">
                        <h3 class="requirement">Wait for delivery of the card</h3>
                        <p>After completing the necessary steps, the identity card will be delivered within twenty (20) working days to your mailing address.</p>
                    </div>
                </div>        
            </div>
            ...
            <div class="location-info">
                <iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3959.4532126723448!2d125.60891747488778!3d7.073336292929392!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x32f96d9e429c078b%3A0x616d8f63b02d491d!2sDavao%20City%20Central%20Post%20Office!5e0!3m2!1sen!2sph!4v1716540120922!5m2!1sen!2sph" width="600" height="450" style="border:0;" allowfullscreen="" loading="lazy" referrerpolicy="no-referrer-when-downgrade"></iframe>
                <div class="details-container">
                    <!-- LIST OF LOCATIONS -->
                    <div class="location-details">
                        <strong><p><a rel="noopener noreferrer" target="_blank" href="https://maps.app.goo.gl/kRF9V6Emo9oGRSUc8">CENTRAL POST OFFICE (CPO) DAVAO</a></p></strong>                 
                        <p><a rel="noopener noreferrer" target="_blank" href="https://maps.app.goo.gl/kRF9V6Emo9oGRSUc8">Davao CPO Roxas Ext Brgy 32</a></p>
                        <table>
                            <tr>
                                <td>Day</td>
            ...
            <div class="fee-info" hidden>
                <div class="fee">
                    <table>
                            <tr>
                                <strong><td class="fee-name">Postal ID Card</td></strong>
                                <td rowspan="2">PHP 450.00</td>
                            </tr>
                            <tr>
                ...
                <div class="fee">
                    <table>
                            <tr>
                                <strong><td class="fee-name">Value Added Tax (VAT)</td></strong>
                                <td rowspan="2">PHP 54.00</td>
                            </tr>
                            <tr>
                                <td class="fee-location">-</td>                    
                            </tr>
                ...
                <div class="total-fee fee">
                    <table>
                            <tr>
                                ...
                                <td rowspan="2"><strong>PHP 504.00</strong></td>
                            </tr>
                    </table>
                </div>
            </div>     
            ...
            <div class="samplephoto-info">
                ...
                <div class="img-magnifier-container">
                    <img id="reference-photo" src="id photos/postal id.png" alt="">
                </div>
            </div>
            ...
            <div class="reference-info">
                <div class="article-reference">
                    <a href="https://www.postalidph.com/how-to-apply.html">How to Apply for Postal ID</a>
                </div>
                <div class="article-reference">
                    <a target="_blank" href="https://www.postalidph.com">Sample Postal ID</a>
                </div>
            </div>
        </section>
    </div>
