    ...
    <div class="whole-document-area">
        <section class="document-area">
            <div class="image-wrapper">
                ...
                <div class="document-text">
                    <h1>Overseas Workers Welfare Administration (OWWA) ID</h1>
                    <p>
                        The OWWA ID is a valid ID used for dealing with the programs and services within the agency.  
                        As it is recognized as a valid ID, holders may use this for social benefits, scholarships, and training programs.
                    </p>
                </div>
            </div>
        </section>    
        ...
        <section class="information-area">
            ...
            <div class="requirement-info">
                <div class="info-box">
                    <h3 class="requirement">Membership Requirement</h3>
                    <p>Active OWWA Membership (with at least 90-day validity from the application date)</p>
                </div>
                <div class="info-box">
                    <h3 class="requirement">Certification Requirement</h3>
                    <p>Valid Overseas Employment Certificate (OEC) or Exemption Number</p>
                </div>
                <div class="info-box">
                    <h3 class="requirement">Identification Requirement</h3>
                    <p>Valid <a href="Passport ID.html">passport</a></p>
                </div>            
            </div> 
            ...
            <div class="procedure-info">
                <div class="info-box">
                    ...
                    <div class="info-details">
                        ...
                        <p>Visit the <a target="_blank" href="https://ecard.owwa.gov.ph">official website application form</a> of OWWA OFW eCard and supply the necessary details.</p>
                    </div>
                </div>
                <div class="info-box">
                    <div class="circle-background">
                    ...
                    <div class="info-details">
                        <h3 class="requirement">Complete the required steps</h3>
                        <p>Tick the box to agree to the data privacy disclaimer. Finish the CAPTCHA challenge, then click submit.</p>
                    </div>
                </div>
                <div class="info-box">
                    <div class="circle-background">
                    ...
                    <div class="info-details">
                        <h3 class="requirement">Application confirmation</h3>
                        <p>The system will display your tracking number, confirming that your application has been approved. You'll need this number for follow-ups, so write it down or snap a screenshot.</p>
                    </div>
                </div>
                <div class="info-box">
                    <div class="circle-background">
                    ...
                    <div class="info-details">
                        <h3 class="requirement">Check status</h3>
                        <p>To find out the current status of your OFW ID, use your email address or Facebook profile.</p>
                    </div>
                </div>
                <div class="info-box">
                    <div class="circle-background">
                    ...
                    <div class="info-details">
                        <h3 class="requirement">Pick preferred office</h3>
                        <p>You can pick your preferred OWWA Regional Office to pick up your OFW ID after you have the all-clear.</p>
                    </div>
                </div>
                <!--------------------------- RENEWAL ----------------------------->
                <div class="subtype">
                    ...
                    <div class="info-box">
                        ...
                        <div class="info-details">
                            <h3 class="requirement">Option 1</h3>
                            <p>Download the <a target="_blank" href="https://play.google.com/store/apps/details?id=com.owwamobileappv2&hl=en&gl=US">OWWA Mobile App</a>.</p>
                        </div>
                    </div>
                    <div class="info-box">
                        <div class="circle-background">
                        ...
                        <div class="info-details">
                            <h3 class="requirement">Option 2</h3>
                            <p>Visit the nearest Philippine Overseas Labor Office- Overseas Workers Welfare Administration (POLO-OWWA) in your country.</p>
                        </div>
                    </div>
                    <div class="info-box">
                        <div class="circle-background">
                        ...
                        <div class="info-details">
                            <h3 class="requirement">Option 3</h3>
                            <p>Visit the nearest OWWA Regional Welfare Offices in Davao City.</p>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="location-info">
                <iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3959.432780436798!2d125.62135102488772!3d7.075718692927063!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x32f96da26d83ae9f%3A0x6068b402074d7e0b!2sOverseas%20Workers%20Welfare%20Administration%20-%20Davao%20City!5e0!3m2!1sen!2sph!4v1716538819501!5m2!1sen!2sph" width="600" height="450" style="border:0;" allowfullscreen="" loading="lazy" referrerpolicy="no-referrer-when-downgrade"></iframe>
                <div class="details-container">
                    <!-- LIST OF LOCATIONS -->
                    <div class="location-details">
                        <strong><p>Overseas Workers Welfare Administration - Davao City</p></strong>                 
                        <p>T.Monteverde St, Poblacion District, Davao City</p>
                    </div>
            ...
            <div class="fee-info" hidden>
                <div class="fee">
                    <table>
                            <tr>
                                <strong><td class="fee-name">Membership contribution</td></strong>
                                <td rowspan="2">US$25.00</td>
                            </tr>
                            <tr>
                ...
                <div class="total-fee fee">
                    <table>
                            <tr>
                                ...
                                <td rowspan="2"><strong>US$25.00</strong></td>
                            </tr>
                    </table>
                </div>
            </div>     
            ...
            <div class="samplephoto-info">
                ...
                <div class="img-magnifier-container">
                    <img id="reference-photo" src="id photos/OWWA ID.jpeg" alt="">
                </div>
            </div>
            ...
            <div class="reference-info">
                <div class="article-reference">
                    <a target="_blank" href="https://www.moneymax.ph/government-services/articles/ofw-id-card-guide">Unlock OWWA Benefits: How to Get an OFW ID in the Philippines</a>
                </div>
                <div class="article-reference">
                    <a target="_blank" href="https://images.gmanews.tv">Sample OWWA ID </a>
                </div>
            </div>
        </section>
    </div>
