...
<head>
    ...
    <title>Pantawid Pamilyang Pilipino Program Card</title>
    ...
    <div class="whole-document-area">
        <section class="document-area">
            <div class="image-wrapper">
                ...
                <div class="document-text">
                    <h1>Pantawid Pamilyang Pilipino Program Card</h1>
                    <p>
                        The Pantawid Pamilyang Pilipino Program card is issued to Filipinos with low income and aims to aid cash grants based on their education and <br> health 
                        conditionalities for a maximum of seven (7) years. This program is a national poverty reduction strategy under the Republic Act No. 11310 or <br> the 
                        "An Act institutionalizing Pantawid Pamilyang Pilipino Program (4Ps) last 2019.
                    </p>
                </div>
            </div>
        </section>    
        ...
        <section class="information-area">
            ...
            <div class="requirement-info">
                <div class="info-box">
                    <h3 class="requirement"><a href="">Birth certificates</a></h3>
                    <p>A document copy of all family members.</p>
                </div>
                <div class="info-box">
                    <h3 class="requirement">Copy of School ID/s</h3>
                    <p>A first grading period school report cards of all children in the family who attended school</p>            
                </div>
                <div class="info-box">
                    <h3 class="requirement"><a href="">Barangay certificate</a></h3>
                </div>
                <div class="info-box">
                    <h3 class="requirement">1x1 photo</h3>
                    <p>Two copies of 1x1 photo with white background</p>
                </div>
                <div class="info-box">
                    <h3 class="requirement">Health records</h3>
                    <p>Copy of health records of 0-5 years old from the health center</p>
                </div>
                <div class="info-box">
                    <h3 class="requirement">Valid IDs of the family member</h3>
                </div>
            </div> 
            ...
            <div class="procedure-info">
                <div class="info-box">
                    ...
                    <div class="info-details">
                        <h3 class="requirement">Eligibility Confirmation</h3>
                        <p>The NHTS-PR sends the profile of low-income households (HHs) who it believes to be eligible participants to the PMED of the 4Ps NPMO for assessment and planning. After that, the PMED goes through the motions of an eligibility verification procedure to determine who these people are.</p>                    
                    </div>
                </div>
                <div class="info-box">
                    <div class="circle-background">
                    ...
                    <div class="info-details">
                        <h3 class="requirement">4P's List Approval</h3>
                        <p>The DSWD Beneficiary Data Management Division (BDMD) receives the list of approved HHs, which is registered and verified before being sent to the next step.</p>
                    </div>
                </div>
                <div class="info-box">
                    <div class="circle-background">
                    ...
                    <div class="info-details">
                        <h3 class="requirement">Beneficiary registration</h3>
                        <p>
                            Beneficiary registration is the procedure that determines who is eligible to participate in a program and enroll them in that program. 
                            This process needs to be carried out carefully to guarantee that the information is correct and that the protocols are carried out appropriately.
                        </p>
                    </div>
                </div>
                <div class="info-box">
                    ...
                    <div class="info-details">
                        <h3 class="requirement">Collaboration for Cash Award Payments</h3>
                        <p>The Department of Social and Welfare Development (DSWD) and the Basic Rights and Freedoms Institute (BRFI) are collaborating to determine the most suitable payment method for cash awards. After that, the two organizations will agree on the most advantageous MOP for the financial grants.</p>
                    </div>
                </div>
                <div class="info-box">
                    <div class="circle-background">
                    ...
                    <div class="info-details">
                        <h3 class="requirement">Benefits of Transaction Accounts</h3>
                        <p>A transaction account is a kind of payment that allows users to accept and transfer cash in addition to electronic money. Its primary goal is to motivate participants of the Health and Human Services program to utilize agent banking and save money.</p>
                    </div>
                </div>
                <div class="info-box">
                    <div class="circle-background">
                    ...
                    <div class="info-details">
                        <h3 class="requirement">Understanding Cash Cards</h3>
                        <p>A cash card, commonly referred to as a prepaid card, is a form of payment that allows recipients to withdraw funding from an ATM or a point-of-sale terminal that the BRFI or the AGDB runs.</p>
                    </div>
                </div>
                <div class="info-box">
                    <div class="circle-background">
            ...
            <div class="location-info">
                <iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3959.4556298852904!2d125.61595427488768!3d7.073054392929677!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x32f96d99ad669165%3A0xe9d4f964e3b6a360!2sDSWD%20Field%20Office%20XI!5e0!3m2!1sen!2sph!4v1716082776578!5m2!1sen!2sph" width="600" height="450" style="border:0;" allowfullscreen="" loading="lazy" referrerpolicy="no-referrer-when-downgrade"></iframe>
                <div class="details-container">
                    <!-- LIST OF LOCATIONS -->
                    <div class="location-details">
                        <strong><p>Department of Social Welfare and Development XI</p></strong>                 
                        <p>36 D Suazo St, Poblacion District, Davao City, Davao del Sur</p>
                        <table>
                            <tr>
                                <td>Day</td>
            ...
            <!--Fees-->
            <div class="fee-info">
                <p style="color: white;"><em>No fee was mentioned here.</em></p>
            </div>     
            ...
            <div class="samplephoto-info">
                ...
                <div class="img-magnifier-container">
                    <img id="reference-photo" src="id photos/4ps id.jpg" alt="">
                </div>
            </div>
            ...
            <div class="reference-info">
                <div class="article-reference">
                    <a href="https://owwamember.com/dswd-4ps-pantawid-pamilyang-pilipino-program/" target="_blank" rel="noopener noreferrer">How to apply 4Ps: Pantawid Pamilyang Pilipino Program </a>
                </div>
                    <div class="article-reference">
                    <a href="https://dswdprogram.com/4ps-pantawid-pamilyang-pilipino-program/" target="_blank" rel="noopener noreferrer">How to register for the DSWD 4Ps Pantawid Pamilyang Pilipino Program</a>
                </div>
                <div class="article-reference">
                    <a target="_blank" href="https://www.affordablecebu.com" target="_blank" rel="noopener noreferrer">Sample 4Ps ID</a>
                </div>
            </div>
        </section>
    </div>
